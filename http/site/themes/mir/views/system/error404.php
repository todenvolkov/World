...
<head>
<title><?php echo CHtml::encode("Такая страница не найдена"); ?></title>
<meta charset="UTF-8">
...
<div class="not-exist">
  ...
  <p>Мы уже работаем над созданием и наполнением этой страницы.</p>
  <span>Воспользуйтесь <a href="/">картой сайта</a>,<br /> либо перейдите на <a href="/">главную страницу</a>.</span>
