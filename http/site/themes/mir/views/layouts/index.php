...
<div class="banner-wrapper">
  <div class="banner">
    <div class="video">
      <div class="player">
        <?php $this->widget("application.modules.contentblock.widgets.ContentBlockWidget", array("code" => "youtube")); ?>
      </div>
      ...
      <div class="information">
          <h1>вас увидят <strong>вас узнают</strong></h1>
          <p>Оператор наружной рекламы занимающий лидирующие позиции на рекламном рынке в г. Тюмень</p>
          <h2>Специалисты <strong>компании</strong>:</h2>
          <ul>
              <li class="first">Предложат оптимальный маркетинговый план</li>
              <li>Разработают дизайн-проект</li>
              <li>Изготовят рекламную конструкцию</li>
              <li>Напечатают баннер</li>
              <li>Согласуют проект в администрации</li>
              <li class="last">Разместят рекламу на улицах города</li>
          </ul>
          <span>Наружная реклама - это сложный технологический процесс, потому "Компания МИР" всегда делает ставку на выскокое качество и использует при проектировании и производстве современные рекламные технологи и материалы.</span> <a href="<?=Yii::app()->createUrl("/pages/whyweare")?>" class="more">Почему мы?</a> <a href="/pages/whyweare" class="learn-more">узнайте больше!</a> </div>
  </div>
</div>
<!--.BANNER-WRAPPER ENDS-->
...
<div id="wrap">
  <div class="our-contacts">
    ...
    <ul class="clearfix">
      <li><a href="<?=Yii::app()->createUrl("/pages/optimization")?>">Оптимизируем затраты <img src="<?=Yii::app()->theme->baseUrl?>/images/001.png" width="107" height="135" alt="" /></a></li>
      <li><a href="<?=Yii::app()->createUrl("/pages/location-and-agreement")?>">размещаем и согласовываем <img src="<?=Yii::app()->theme->baseUrl?>/images/002.png" width="86" height="135" alt="" /></a></li>
      <li><a href="<?=Yii::app()->createUrl("/pages/design-and-production")?>">проектируем и изготавливаем <img src="<?=Yii::app()->theme->baseUrl?>/images/003.png" width="104" height="135" alt="" /></a></li>
      <li><a href="<?=Yii::app()->createUrl("/pages/analysis-and-maintenance")?>">Анализируем и сопровождаем <img src="<?=Yii::app()->theme->baseUrl?>/images/004.png" width="92" height="135" alt="" /></a></li>
    </ul>
  </div>
  <!--.OUR-CONTANTS ENDS-->
  ...
  <div class="solutions-block">
    ...
    <ul class="solutions clearfix">
      <li><a href="<?=Yii::app()->createUrl("/pages/solution-for-small-business")?>">Молодой бизнес</a> У вас молодой перспективный бизнес нуждающийся в активном привлечении клиентов, при условии скромного бюджета на рекламу. </li>
      <li><a href="<?=Yii::app()->createUrl("/pages/solution-for-medium-business")?>">Оптима</a> Максимальный охват аудитории, при оптимальных вложениях для удержания занятых  позиций бизнеса и активного продвижения вперед.</li>
      <li><a href="<?=Yii::app()->createUrl("/pages/solution-for-big-business")?>">Премиум</a> Хороший бизнесмен ни когда не забывает о подростающей конкуренции. Закрепляем позиции с мксимальным размахом.</li>
    </ul>
    <ul class="clearfix">
      <li class="read-more"><a href="<?=Yii::app()->createUrl("/pages/solution-for-small-business")?>">Подробнее</a></li>
      <li class="read-more"><a href="<?=Yii::app()->createUrl("/pages/solution-for-medium-business")?>">Подробнее</a></li>
      <li class="read-more"><a href="<?=Yii::app()->createUrl("/pages/solution-for-big-business")?>">Подробнее</a></li>
    </ul>
    <a href="<?=Yii::app()->createUrl("/pages/other-options")?>" class="more">Другие варианты</a> </div>
