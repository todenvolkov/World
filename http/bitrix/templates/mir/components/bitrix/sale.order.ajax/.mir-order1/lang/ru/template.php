...
$MESS["SOA_TEMPL_BUTTON"] = "Отправить заказ";
...
$MESS["SOA_TEMPL_ORDER_SUC"] = "Ваш заказ <p class='Header'>№#ORDER_ID#</p> от #ORDER_DATE# <br>успешно создан.";
$MESS["SOA_TEMPL_ORDER_SUC1"] = "Вы можете следить за выполнением своего заказа в <br><a href=\"#LINK#\">Персональном разделе сайта</a>. <br><br>Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.<br><br>Успехов!";
...
$MESS["STOF_2REG"] = "Для регистрированных пользователей";
$MESS["STOF_2NEW"] = "Для новых Заказчиков";
