...
<?
	...
	$arTransParams = array(
		...
		'INIT_MAP_LON' => $arResult['INIT_MAP_LON'],
		'INIT_MAP_LAT' => $arResult['INIT_MAP_LAT'],
		'INIT_MAP_SCALE' => $arResult['INIT_MAP_SCALE'],
...
function add2basket(){
	...
	remote.alertMessage('message from remote - ID='+c_request_id+"&PARAM="+c_request_array.join(','));
	return false;
}
