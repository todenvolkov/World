...
$MESS ['ELEMENT_ID_TIP'] = "The code that evaluates to the element ID. You can specify the ID explicitly, or obtain it from the REQUEST array. The default value is <b>={\$_REQUEST[\"ELEMENT_ID\"]}</b>";
