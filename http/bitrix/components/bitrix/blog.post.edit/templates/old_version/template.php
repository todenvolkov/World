	...
	else
	{
		...
		<?=bitrix_sessid_post();?>
			...
			<?if($arResult["bSoNet"] != "Y")
			{
				...
				?>
				<tr>
					<th valign="top" align="right" nowrap><b><?=GetMessage("BLOG_ACCESS")?></b></th>
					<td valign="top">
						...
						<table class="blog-blog-edit-table">
							...
							<tr>
								...
								<td><?=ShowSelectPerms('p', 1, $arResult["PostToShow"]["arUGperms_p"][1], $arResult["BLOG_POST_PERMS"]);?></td>
								<td><?=ShowSelectPerms('c', 1, $arResult["PostToShow"]["arUGperms_c"][1], $arResult["BLOG_COMMENT_PERMS"]);?></td>
							</tr>
							<tr>
								<td><?=GetMessage("BLOG_REG_USERS")?></td>
								<td><?=ShowSelectPerms('p', 2, $arResult["PostToShow"]["arUGperms_p"][2], $arResult["BLOG_POST_PERMS"]);?></td>
								<td><?=ShowSelectPerms('c', 2, $arResult["PostToShow"]["arUGperms_c"][2], $arResult["BLOG_COMMENT_PERMS"]);?></td>
							</tr>
							...
							foreach($arResult["UserGroups"] as $aUGroup)
							{
								...
								<tr>
									<td><?=$aUGroup["NAME"]?></td>
									<td><?=ShowSelectPerms("p", $aUGroup["ID"], $arResult["PostToShow"]["arUGperms_p"][$aUGroup["ID"]], $arResult["BLOG_POST_PERMS"])?></td>
									<td><?=ShowSelectPerms("c", $aUGroup["ID"], $arResult["PostToShow"]["arUGperms_c"][$aUGroup["ID"]], $arResult["BLOG_COMMENT_PERMS"])?></td>
								</tr>
								<?
							}
							?>
			...
			<?if($USER->IsAdmin()):?>
				<tr>
					<td colspan="2"><a href="/bitrix/admin/userfield_edit.php?lang=ru&ENTITY_ID=BLOG_POST&back_url=<?=$arResult["CUR_PAGE"]?>"><?=GetMessage("BLOG_POST_PROPERTY_ADD")?></a></th>
				</tr>
			<?endif;?>
			</table>
			<br />
