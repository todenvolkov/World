...
$MESS ['P_THUMBS_SIZE'] = "Размер детальной фотографии (px)";
$MESS ['P_GALLERY_AVATAR_SIZE'] = "Размер аватара галереи (используется при работе компонента в многопользовательском режиме, px)";
