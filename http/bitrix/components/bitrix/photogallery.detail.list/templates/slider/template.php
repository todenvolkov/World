...
$arParams["THUMBS_SIZE"] = (intVal($temp["WIDTH"]) > 0 ? intVal($temp["WIDTH"]) : 200);
...
$arParams["THUMBS_SIZE"] = ($arParams["THUMBS_SIZE"] > 0 ? $arParams["THUMBS_SIZE"] : 200);
/********************************************************************
				/Input params
********************************************************************/
...
<style>
.photo-slider-container, .photo-slider-container .photo-slider-data-list{height:<?= ($arParams["THUMBS_SIZE"] + 20)?>px;}
.photo-slider-container .photo-slider-item .photo-slider-thumb {height:<?=($arParams["THUMBS_SIZE"] + 20)?>px;}
</style>
