...
{
	$url = CComponentEngine::MakePathFromTemplate($arResult["URL_TEMPLATES"]["section_edit"], 
		array("SECTION_ID" => intval($arResult["VARIABLES"]["SECTION_ID"]), "ACTION" => "new")); 
}
if ($arParams["SHOW_NAVIGATION"] != "N" && strtolower($arResult["PAGE_NAME"]) != "index"):
// text from main
