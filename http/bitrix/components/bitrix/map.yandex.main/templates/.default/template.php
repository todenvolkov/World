...
?>
<img src="/bitrix/components/bitrix/map.yandex.main/templates/.default/images/screenshot.png" border="0" />
<?
else:
...
echo '<pre>'; print_r($arTransParams); echo '</pre>';
