...
__IncludeLang($_SERVER['DOCUMENT_ROOT'].'/bitrix/components/bitrix/map.yandex.main/lang/'.LANGUAGE_ID.'/settings.php');
...
?>
<script type="text/javascript" src="/bitrix/components/bitrix/map.yandex.main/settings/settings_load.js"></script>
<script type="text/javascript">
BX.loadCSS('/bitrix/components/bitrix/map.yandex.main/settings/settings.css');
