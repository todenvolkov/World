...
?>
	<tr>
		...
		<td><input type="text" name="search_phrase" value="<?=$search_phrase?>" ></td>
	</tr>
	<tr>
...
?>
	<tr>
		<td><?echo GetMessage("TR_SEARCH_PHRASE")?>:</td>
		<td><input type="text" name="search_phrase2" value="<?=$search_phrase?>" ></td>
	</tr>
	<tr>
		<td><?echo GetMessage("TR_REPLACE_PHRASE")?>:</td>
		<td><input type="text" name="replace_phrase2" value="<?=$replace_phrase?>" ></td>
	</tr>	
	<tr>
		<td><?echo GetMessage("TR_SEARCH_MESSAGE")?>:</td>
