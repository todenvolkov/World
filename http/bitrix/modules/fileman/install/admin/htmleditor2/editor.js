...
BXHTMLEditor.prototype.OnLoad = function()
{
	...
	this.bodyParams = ""; // Used to add some 
	...
	BXHTMLEditor.prototype.OnDblClick = function (e)
	{
		...
		{
			if (oTag.tag == "img")
				this.OpenEditorDialog("image", null, 500);
			else if (oTag.tag == "a")
				this.OpenEditorDialog("link", null, 520);
			if (oTag.tag == "anchor")
...
BXHTMLEditor.prototype.SetEditorContent = function(sContent)
{
	...
	addAdvEvent(document, 'keydown', BX.proxy(function(e){return this.OnKeyPress(e, false)}, this));
