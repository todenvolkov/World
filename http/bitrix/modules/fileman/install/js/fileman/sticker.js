...
BXSticker.prototype = {
	...
	Request : function(action, postParams, callBack, bShowWaitWin)
	{
		...
		var actionUrl = '/bitrix/admin/fileman_stickers.php?sticker_action=' + action + "&" + this.sessid_get;
	...
	InitMagicAdjust: function(ind)
	{
		...
		if (!this.magicNodes)
		{
			...
			//console.info(arLinks.length);
			// console.info(arImgs.length);
			// console.info(arDivs.length);
			//console.info(nodes.length);
		}

		//console.dir(this.magicNodes.nodes);
		//return;
		var
			node,
			oSt = this.arStickers[ind],
		...
		//console.info(mTop, mLeft, mRight, mBottom);
...
BXStickerList.prototype = {
	Show: function(type)
	{
		...
		var Config = {
			content_url: '/bitrix/admin/fileman_stickers.php?sticker_action=show_list&' + this.BXSticker.sessid_get + '&cur_page=' + this.BXSticker.Params.pageUrl + '&type=' + type,
