...
$tabControl->BeginNextTab();?>
	...
	<?if(!$bEdit):?>
		...
		<tr>
			...
			<td width="70%"><input id="bxfm_title" type="text" name="title" size="50" maxlength="255" value="<?echo htmlspecialchars($title)?>"></td>
		</tr>
		<?endif;?>
		<tr>
			...
			<td>
				<?if (isset($filename2))
					$filename = $filename2;?>
				<input type="text" name="filename" id="bxfm_filename" style="float: left;" size="50" maxlength="255" value="<?echo htmlspecialchars($filename)?>"></td>
		</tr>
