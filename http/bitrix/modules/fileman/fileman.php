...
class CFileMan
{
	...
	function OnPanelCreate()
	{
		...
		//Sticker buttons
		include_once($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/modules/fileman/classes/general/sticker.php");
		if (CSticker::CanDoOperation('sticker_view'))
		{
			...
			{
				$arMenu[] = array(
					"TEXT" => '<div style="float: left; margin: 0 50px 0 0;">'.GetMessage("FMST_PANEL_STICKER_ADD").'</div><div style="float: right;"><nobr>Ctrl+Shift+S</nobr></div>',
			...
			$arMenu[] = array(
				...
				//"TEXT" => GetMessage("FMST_PANEL_STICKERS_SHOW", array("#COUNT#" => CSticker::GetCurPageCount())),
				"TEXT" => '<div style="float: left; margin: 0 50px 0 0;">'.GetMessage("FMST_PANEL_STICKERS_SHOW", array("#COUNT#" => $curPageCount)).'</div><div style="float:right;"><nobr>Ctrl+Shift+X</nobr></div>',
			...
			$arMenu[] = array(
				...
				"TEXT" => '<div style="float: left; margin: 0 50px 0 0;">'.GetMessage("FMST_PANEL_CUR_STICKER_LIST").'</div><div style="float: right;"><nobr>Ctrl+Shift+L</nobr></div>',
			...
			$APPLICATION->AddPanelButton(array(
				...
				"HINT" => array(
					...
					"TEXT" => CSticker::CanDoOperation('sticker_edit') ? GetMessage("FMST_PANEL_STICKERS_TOOLTIP")." (Ctrl+Shift+S)" : GetMessage("FMST_PANEL_STICKERS_ALT")." (Ctrl+Shift+X)"
				)
			));
