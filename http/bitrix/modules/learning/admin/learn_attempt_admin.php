...
<?$filter->Begin();?>
 	...
 	<tr>
		...
		<td><input type="text" name="filter_user" value="<?echo htmlspecialchars($filter_user)?>" size="47"></td>
	</tr>
	...
	<tr>
		<td><?echo GetMessage("LEARNING_ADMIN_DATE_START")." (".CLang::GetDateFormat("SHORT")."):"?></td>
	...
	<tr>
		<td><?echo GetMessage("LEARNING_ADMIN_DATE_END")." (".CLang::GetDateFormat("SHORT")."):"?></td>
