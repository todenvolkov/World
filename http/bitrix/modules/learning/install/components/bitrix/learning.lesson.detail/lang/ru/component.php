...
$MESS["LEARNING_COURSES_LESSON_DELETE"] = "Удалить урок";
$MESS["LEARNING_COURSES_LESSON_DELETE_CONF"] = "Будет удалена вся информация, связанная с этой записью! Продолжить?";
