...
<?foreach($arResult["RECORDS"] as $arGradebook):?>
	<tr>
		...
		<td><?=$arGradebook["COMPLETED"]=="Y"?GetMessage("LEARNING_PROFILE_YES"):GetMessage("LEARNING_PROFILE_NO")?> <?php if ($arGradebook["MARK"]):?>(<?php echo GetMessage("LEARNING_PROFILE_MARK")?>: <?php echo $arGradebook["MARK"]?>)<?php endif?></td>
		<td>
