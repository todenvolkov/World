...
(
	COURSE_ID int(11) unsigned not null REFERENCES b_learn_course(ID),
	USER_GROUP_ID int(18) unsigned not null REFERENCES b_group(ID),
...
(
	...
	ACTIVE char(1) not null default 'Y',
	COURSE_ID int(11) unsigned not null REFERENCES b_learn_course(ID),
	CHAPTER_ID int(11) REFERENCES b_learn_chapter(ID),
	NAME varchar(255) not null,
	CODE varchar(50),
	SORT int(11) not null default '500',
	PREVIEW_PICTURE int(18),
	...
	PRIMARY KEY(ID),
	INDEX IX_B_LEARN_CHAPTER1(COURSE_ID, CHAPTER_ID)
);
...
(
	...
	CREATED_BY int(18),
	ACTIVE char(1) not null default 'Y',
	COURSE_ID int(11) unsigned not null default '0' REFERENCES b_learn_course(ID),
	CHAPTER_ID int(11) unsigned REFERENCES b_learn_chapter(ID),
	NAME varchar(255) not null,
	SORT int(11) not null default '500',
	PREVIEW_PICTURE int(18),
	PREVIEW_TEXT text,
	...
	LAUNCH text,
	PRIMARY KEY(ID),
	INDEX IX_B_LEARN_LESSON1(COURSE_ID, CHAPTER_ID)
);
