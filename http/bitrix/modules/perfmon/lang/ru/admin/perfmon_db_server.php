...
$MESS["PERFMON_KPI_NAME_TABLE_CACHE"] = "Кеш открытых таблиц";
$MESS["PERFMON_KPI_REC_TABLE_CACHE"] = "Эффективность кеша открытых таблиц (#STAT_NAME#). Если значение эффективности менее #GOOD_VALUE#, то требуется увеличить значение параметра #PARAM_NAME# (текущее значение: #PARAM_VALUE#). Увеличивайте параметр постепенно чтобы избежать превышения лимитов на количество одновременно открытых файлов в операционной системе.";
...
$MESS["PERFMON_REC_PARAMETER_VALUE"] = "Рекомедуемое значение";
...
$MESS["PERFMON_KPI_ORA_REC_CURSOR__PIN_S_WAIT_ON_X"] = "Следует обратить внимание на параметр <span class=\"perfmon_code\">CURSOR_SHARING</span>, статистику по объектам и значение <span class=\"perfmon_code\">METOD_OPT</span> при сборе статаистики. Сессия пытается получить разделяемую блокировку которая удерживается другой сессией.";
