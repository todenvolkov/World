...
$MESS ['SALE_DH_EMS_DESCRIPTION_INNER'] = "Обработчик службы доставки \"EMS Почта России\". Доставка только из России. Работает на основе <a href=\"http://www.emspost.ru/service/online/api\" target=\"_blank\">публичного API службы</a>.<br />Необходима установка адреса магазина в <a href=\"/bitrix/admin/settings.php?mid=sale&lang=ru\">настройках модуля</a>.";
