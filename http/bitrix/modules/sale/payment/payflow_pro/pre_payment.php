	...
	<table border="0" width="100%" cellpadding="2" cellspacing="2">
		<tr>
			...
			<td class="tablebody" width="60%">
				<input class="inputtext" type="text" name="cardnum" value="<?= htmlspecialchars($_REQUEST["cardnum"]) ?>" size="35">
			</td>
		</tr>
		<tr>
			<td align="right" class="tablebody" width="40%">
			...
			<td class="tablebody" width="60%">
				<input type="text" class="inputtext" name="cvv2" value="<?= htmlspecialchars($_REQUEST["cvv2"]) ?>" size="5">
			</td>
		</tr>
		<tr>
			<td align="right" class="tablebody" width="40%">
		...
		<tr>
			...
			<td class="tablebody" width="60%">
				<input type="text" class="inputtext" size="40" name="noc" value="<?= (strlen($_REQUEST["noc"]) > 0) ? htmlspecialchars($_REQUEST["noc"]) : $noc_def ?>">
			</td>
		</tr>
		<tr>
			<td align="right" class="tablebody" width="40%">
			...
			<td class="tablebody" width="60%">
				<input type="text" class="inputtext" size="40" name="address1" value="<?= (strlen($_REQUEST["address1"]) > 0) ? htmlspecialchars($_REQUEST["address1"]) : $address1_def ?>">
			</td>
		</tr>
		<tr>
			<td align="right" class="tablebody" width="40%">
			...
			<td class="tablebody" width="60%">
				<input type="text" class="inputtext" size="7" name="zipcode" value="<?= (strlen($_REQUEST["zipcode"]) > 0) ? htmlspecialchars($_REQUEST["zipcode"]) : $zipcode_def ?>">
			</td>
		</tr>
	</table>
	<?
