...
if ($bSuccessProcess)
{
	?><p><font class="oktext">Transaction processed successfully</font></p><?
}
else
{
	if (strlen($strErrorMessage)>0)
	...
	<table border="0" cellpadding="3" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td class="tablebody"><input type="text" class="inputtext" name="ccard_num" size="30" value="<?= htmlspecialchars($_REQUEST["ccard_num"]) ?>"></td>
		</tr>
		<tr>
			<td align="right" class="tablebody">
				<font class="tablebodytext">
		...
		<tr>
			...
			<td class="tablebody"><input type="text" class="inputtext" name="ccard_code" size="5" value="<?= htmlspecialchars($_REQUEST["ccard_code"]) ?>"></td>
		</tr>
		<tr>
