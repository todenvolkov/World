<?if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die();?><form action="https://Rbkmoney.ru/acceptpurchase.aspx" method="POST" name="payment_form">
	...
	<input type="hidden" name="recipientCurrency" value="<?=CSalePaySystemAction::GetParamValue("CURRENCY")?>">
	...
	<input type="hidden" name="userEmail" value="<?=CSalePaySystemAction::GetParamValue("EMAIL")?>">
