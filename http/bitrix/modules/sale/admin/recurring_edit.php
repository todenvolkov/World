...
?>
	...
	<?endif;?>
	<tr>
		<td width="40%"><span class="required">*</span><?echo GetMessage("SRE_USER1")?></td>
		<td width="60%"><?
	...
	<?if (!$bSimpleForm):?>
		<?if ($saleModulePermissions >= "W"):?>
			<tr>
				<td><span class="required">*</span><?echo GetMessage("SRE_CALLBACK")?></td>
				<td><input type="text" name="CALLBACK_FUNC" size="30" maxlength="30" value="<?=$str_CALLBACK_FUNC?>"></td>
			</tr>
		<?endif;?>
	<?endif;?>
	<tr>
		<td><span class="required">*</span><?echo GetMessage("SRE_PRODUCT")?></td>
		<td>
			<?if ($saleModulePermissions >= "W"):?>
				<script language="JavaScript">
				<!--
				...
				<input name="PRODUCT_ID" value="<?= $str_PRODUCT_ID ?>" size="5" type="text">&nbsp;<input type="button" value="..." id="cat_prod_button" onClick="window.open('sale_product_search.php?func_name=FillProductFields', '', 'scrollbars=yes,resizable=yes,width=600,height=500,top='+Math.floor((screen.height - 500)/2-14)+',left='+Math.floor((screen.width - 600)/2-5));">
				<script language="JavaScript">
				<!--
				ModuleChange();
				//-->
	...
	<?endif;?>
	<tr>
		<td valign="top"><?echo GetMessage("SRE_LAST_DATE")?><?= CSite::GetDateFormat("FULL", LANG);?>):</td>
		<td valign="top">
			<?= CalendarDate("PRIOR_DATE", $str_PRIOR_DATE, "frecurring_edit", "20", "class=\"typeinput\""); ?>
		</td>
	</tr>
	<tr>
		<td valign="top"><span class="required">*</span><?echo GetMessage("SRE_NEXT_DATE")?><?= CSite::GetDateFormat("FULL", LANG);?>):</td>
		<td valign="top">
	...
	<tr>
		<td><span class="required">*</span><?echo GetMessage("SRE_BASE_ORDER")?></td>
		<td>
