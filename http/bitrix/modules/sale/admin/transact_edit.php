...
?>
	...
	<tr>
		<td width="40%"><span class="required">*</span><?echo GetMessage("STE_USER")?></td>
		<td width="60%"><?
			if ($ID > 0)
	...
	<tr>
		<td><span class="required">*</span><?echo GetMessage("STE_DATE")?><?= CSite::GetDateFormat("FULL", LANG);?>):</td>
		<td><?
	...
	<tr>
		<td><span class="required">*</span><?echo GetMessage("STE_SUM")?></td>
		<td>
