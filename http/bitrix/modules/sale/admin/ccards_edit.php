...
?>
	...
	<?endif;?>
	<tr>
		<td width="40%"><span class="required">*</span><?echo GetMessage("SCE_USER")?></td>
		<td width="60%"><?
			if ($ID>0)
	...
	<tr>
		<td><span class="required">*</span><?echo GetMessage("SCE_PAY_SYSTEM")?></td>
		<td>
	...
	<tr>
		<td><span class="required">*</span><?echo GetMessage("SCE_CARD_NUM")?></td>
		<td>
