...
while ($arPlan = $dbResultList->NavNext(true, "f_"))
{
	...
	$fieldEdit = "<input type=\"text\" name=\"FIELDS[".$f_ID."][BASE_RATE]\" value=\"".htmlspecialchars($val)."\" size=\"7\"> ";
	...
	$fieldEdit = "<input type=\"text\" name=\"FIELDS[".$f_ID."][MIN_PLAN_VALUE]\" value=\"".htmlspecialchars($val)."\" size=\"7\"> ";
