...
<tr> 
	...
	<td class="tablebody"><input class="typeinput" type="text" name="find_login" size="47" value="<?echo htmlspecialchars($find_login)?>"><?=ShowFilterLogicHelp()?></td>
</tr>
<tr> 
...
<tr>
	...
	<td class="tablebody" width="0%" nowrap><font class="tablefieldtext"><?echo CalendarPeriod("find_timestamp_1", htmlspecialchars($find_timestamp_1), "find_timestamp_2", htmlspecialchars($find_timestamp_2), "form1","Y")?></font></td>
</tr>
<tr>
	...
	<td class="tablebody" width="0%" nowrap><font class="tablefieldtext"><?echo CalendarPeriod("find_last_login_1", htmlspecialchars($find_last_login_1), "find_last_login_2", htmlspecialchars($find_last_login_2), "form1","Y")?></font></td>
</tr>
<tr>
	...
	<td class="tablebody" nowrap><?
		...
		echo SelectBoxFromArray("find_active", $arr, htmlspecialchars($find_active), GetMessage('SALE_ALL'));
		?>
	</td>
</tr>
<tr>
	<td class="tablebody" nowrap><font class="tablefieldtext"><?echo GetMessage("SALE_F_EMAIL")?></font></td>
	<td class="tablebody" nowrap><input class="typeinput" type="text" name="find_email" value="<?echo htmlspecialchars($find_email)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td class="tablebody" nowrap><font class="tablefieldtext"><?echo GetMessage("SALE_F_NAME")?></font></td>
	<td class="tablebody" nowrap><input class="typeinput" type="text" name="find_name" value="<?echo htmlspecialchars($find_name)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td class="tablebody" nowrap><font class="tablefieldtext"><?echo GetMessage("SALE_F_KEYWORDS")?></font></td>
	<td class="tablebody" nowrap><input class="typeinput" type="text" name="find_keywords" value="<?echo htmlspecialchars($find_keywords)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="top">
...
<table border="0" cellspacing="1" cellpadding="2" width="100%">
	...
	<tr valign="top">
		...
		<td class="tablebody3" nowrap><input class="button" type="button" onClick="SetValue('<?= $f_ID ?>', '<?= str_replace("'", "\'", str_replace("\\", "\\\\", htmlspecialchars($f_NAME.((strlen($f_NAME)<=0 || strlen($f_LAST_NAME)<=0) ? "" : " ").$f_LAST_NAME." (".$f_LOGIN.")"))) ?>');" value="<?echo GetMessage("SALE_SELECT")?>"></td>
	</tr>
	<?endwhile;?>
	<tr valign="top">
