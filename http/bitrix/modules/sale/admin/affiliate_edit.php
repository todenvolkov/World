...
while ($arSite = $dbSiteList->Fetch())
{
	$i++;
	?>
	arSitesArray[<?= $i ?>] = '<?= $arSite["LID"] ?>';
	arCurrenciesArray[<?= $i ?>] = '<?= CSaleLang::GetLangCurrency($arSite["LID"]) ?>';
	<?
}
?>
//-->
...
?>
	...
	<?endif;?>
	<tr>
		<td width="40%"><span class="required">*</span><?echo GetMessage("SAE_SITE")?></td>
		<td width="60%">
			<script language="JavaScript">
			<!--
	...
	<tr>
		<td><span class="required">*</span><?echo GetMessage("SAE_USER")?></td>
		<td>
			<?
			$userName = "";
			if ($str_USER_ID > 0)
	...
	<tr>
		<td><span class="required">*</span><?echo GetMessage("SAE_PLAN")?></td>
		<td>
			<select name="PLAN_ID">
				<?
	...
	<tr>
		<td><span class="required">*</span><?echo GetMessage("SAE_DATE_REG")?><?= CSite::GetDateFormat("SHORT", LANG); ?>):</td>
		<td>
			<?= CalendarDate("DATE_CREATE", $str_DATE_CREATE, "form1", "20", ""); ?>
		</td>
	</tr>
	<tr>
		<td valign="top"><?echo GetMessage("SAE_PAYED_SUM")?></td>
		<td valign="top">
	...
	<tr>
		<td valign="top"><?echo GetMessage("SAE_PENDING_SUM")?></td>
		<td valign="top">
	...
	<tr>
		<td><?echo GetMessage("SAE_LAST_CALC")?><?= CSite::GetDateFormat("FULL", LANG); ?>):</td>
		<td>
			<?= CalendarDate("LAST_CALCULATE", $str_LAST_CALCULATE, "form1", "20", ""); ?>
		</td>
	</tr>
	<tr>
		<td valign="top"><?echo GetMessage("SAE_AFF_SITE")?>:</td>
		<td valign="top">
			<input type="text" name="AFF_SITE" size="60" maxlength="200" value="<?= $str_AFF_SITE ?>">
		</td>
	</tr>
	<tr>
		<td valign="top"><?echo GetMessage("SAE_AFF_DESCRIPTION")?>:</td>
		<td valign="top">
