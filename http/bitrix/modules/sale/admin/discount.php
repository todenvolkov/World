...
while ($arDiscount = $dbResultList->NavNext(true, "f_"))
{
	...
	$fieldEdit .= "<input type=\"text\" name=\"FIELDS[".$f_ID."][PRICE_FROM]\" value=\"".htmlspecialchars($val)."\" size=\"7\"> ";
	...
	$fieldEdit .= "<input type=\"text\" name=\"FIELDS[".$f_ID."][PRICE_TO]\" value=\"".htmlspecialchars($val)."\" size=\"7\"> ";
	...
	$fieldEdit .= "<input type=\"text\" name=\"FIELDS[".$f_ID."][DISCOUNT_VALUE]\" value=\"".htmlspecialchars($val)."\" size=\"4\"> ";
