...
?>
	...
	<?if ($ID > 0):?>
		...
		<tr>
			...
			?>
			<td width="60%"><?= "[".$arPersType["ID"]."] ".htmlspecialcharsEx($arPersType["NAME"])." (".htmlspecialcharsEx($arPersType["LID"]).")" ?></td>
		</tr>
	<?else:?>
		<tr>
			<td width="40%"><span class="required">*</span><?echo GetMessage("SOPGEN_PERSON_TYPE")?>:</td>
			<td width="60%">
	...
	<?endif;?>
	<tr>
		<td width="40%"><span class="required">*</span><?echo GetMessage("SOPGEN_NAME")?>:</td>
		<td width="60%">
