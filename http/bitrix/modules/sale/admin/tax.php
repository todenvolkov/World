...
while ($arTax = $dbResultList->NavNext(true, "f_"))
{
	...
	$fieldEdit  = "<input type=\"text\" name=\"FIELDS[".$f_ID."][NAME]\" value=\"".htmlspecialchars($valName)."\" size=\"30\"><br>";
	$fieldEdit .= "<input type=\"text\" name=\"FIELDS[".$f_ID."][DESCRIPTION]\" value=\"".htmlspecialchars($valDescr)."\" size=\"30\">";
