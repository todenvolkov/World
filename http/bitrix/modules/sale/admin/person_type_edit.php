...
$dbPersonType = CSalePersonType::GetList($b="", $o="", array("ID" => $ID));
if (!$dbPersonType->ExtractFields("str_"))
{
...
?>
	...
	<?endif;?>
	<tr>
		<td width="40%"><span class="required">*</span><?echo GetMessage("SPTEN_SITE")?>:</td>
		<td width="60%">
			<?echo CSite::SelectBox("LID", $str_LID, "", "", "");?>
		</td>
	</tr>
	<tr>
		<td width="40%"><span class="required">*</span><?echo GetMessage("SPTEN_NAME")?>:</td>
		<td width="60%">
