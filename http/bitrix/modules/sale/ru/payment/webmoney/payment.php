...
?>
<p><font class="tablebodytext"><b>Счет № <?= $ORDER_ID ?> от <?= htmlspecialchars($GLOBALS["SALE_INPUT_PARAMS"]["ORDER"]["DATE_INSERT"]) ?></b></font></p>
<p>
...
<tr>
	...
	<td><font size="-1"><input type="text" name="WEBMONEY_ID" size="30" value="<?= htmlspecialchars($WEBMONEY_ID) ?>"></font></td>
</tr>
</table>
<p><font class="tablebodytext">
