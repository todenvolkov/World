...
<tr valign="top">
	...
	<td style="border:1pt solid #000000; border-bottom:none;" align="center">
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			...
			<tr>
				<td style="border-bottom:1pt solid #000000;"><?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("COMPANY_NAME"))?></td>
			</tr>
			<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				<td style="width:37mm; border-bottom:1pt solid #000000;"><?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("INN"))."/".htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("KPP"))?></td>
				<td style="width:9mm;">&nbsp;</td>
				<td style="border-bottom:1pt solid #000000;"><?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("SETTLEMENT_ACCOUNT"))?></td>
			</tr>
			<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				<td>в&nbsp;</td>
				<td style="width:73mm; border-bottom:1pt solid #000000;"><?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("BANK_NAME"))?></td>
				<td align="right">БИК&nbsp;&nbsp;</td>
				<td style="width:33mm; border-bottom:1pt solid #000000;"><?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("BANK_BIC"))?></td>
			</tr>
			<tr>
				<td></td>
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				...
				<td width="100%" style="border-bottom:1pt solid #000000;"><?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("BANK_COR_ACCOUNT"))?></td>
			</tr>
		</table>
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				<td style="width:60mm; border-bottom:1pt solid #000000;">Оплата заказа № 
	  <?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("ORDER_ID"))?>
	  от 
	  <?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("DATE_INSERT"))?></td>
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				...
				<td width="100%" style="border-bottom:1pt solid #000000;"><?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("PAYER_CONTACT_PERSON"))?></td>
			</tr>
		</table>
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				...
				<td width="100%" style="border-bottom:1pt solid #000000;"><?
					...
					$sAddrFact = "";
					htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("PAYER_ZIP_CODE"));
					if(strlen(CSalePaySystemAction::GetParamValue("PAYER_ZIP_CODE"))>0)
						$sAddrFact .= ($sAddrFact<>""? ", ":"").htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("PAYER_ZIP_CODE"));
					if(strlen(CSalePaySystemAction::GetParamValue("PAYER_COUNTRY"))>0)
						$sAddrFact .= ($sAddrFact<>""? ", ":"").htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("PAYER_COUNTRY"));
					if(strlen(CSalePaySystemAction::GetParamValue("PAYER_CITY"))>0) 
					{
						$g = substr(CSalePaySystemAction::GetParamValue("PAYER_CITY"), 0, 2);
						$sAddrFact .= ($sAddrFact<>""? ", ":"").($g<>"г." && $g<>"Г."? "г. ":"").htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("PAYER_CITY"));
					}
					if(strlen(CSalePaySystemAction::GetParamValue("PAYER_ADDRESS_FACT"))>0) 
						$sAddrFact .= ($sAddrFact<>""? ", ":"").htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("PAYER_ADDRESS_FACT"));
					echo $sAddrFact;
				?>&nbsp;</td>
			</tr>
		</table>
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				...
				if(strpos(CSalePaySystemAction::GetParamValue("SHOULD_PAY"), ".")!==false)
					$a = explode(".", htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("SHOULD_PAY")));
				else
					$a = explode(",", htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("SHOULD_PAY")));
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				...
				<td align="right">&nbsp;&nbsp;&laquo;______&raquo;________________ 200____ г.</td>
			</tr>
		</table>
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
...
<p><b>Примечание:</b>
<?=htmlspecialcharsEx(CSalePaySystemAction::GetParamValue("COMPANY_NAME"))?>
