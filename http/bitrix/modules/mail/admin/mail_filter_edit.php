...
<?$tabControl->BeginNextTab();?>
	...
	<?if($ID>0):?>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_ID")?></td>
		<td><?echo $str_ID?></td>
	</tr>
	<?endif?>
	<?if(strlen($str_TIMESTAMP_X)>0):?>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_DATECH")?></td>
		<td><?echo $str_TIMESTAMP_X?></td>
	</tr>
	<? endif; ?>
	<tr>
		<td valign="top" align="right"><?echo GetMessage("MAIL_FLT_EDT_MBOX")?> </td>
		<td valign="top">
	...
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_ACT")?></td>
		<td><input type="checkbox" name="ACTIVE" value="Y"<?if($str_ACTIVE=="Y")echo " checked"?>></td>
	</tr>
	<tr valign="top">
		<td align="right"><span class="required">*</span><?echo GetMessage("MAIL_FLT_EDT_NAME")?></td>
		<td><input type="text" name="NAME" size="53" maxlength="255" value="<?=$str_NAME?>"></td>
	</tr>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_DESC")?></td>
		<td><textarea name="DESCRIPTION" cols="40" rows="5"><?echo $str_DESCRIPTION?></textarea>
		</td>
	</tr>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_SORT")?></td>
		<td><input type="text" name="SORT" size="4" maxlength="5" value="<?=$str_SORT?>"></td>
	</tr>

	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_WHEN")?></td>
		<td>
		<input type="checkbox" name="WHEN_MAIL_RECEIVED" value="Y" id="WHEN_MAIL_RECEIVED"<?if($str_WHEN_MAIL_RECEIVED=="Y")echo " checked"?>> <label for="WHEN_MAIL_RECEIVED"><?echo GetMessage("MAIL_FLT_EDT_WHEN_RETR")?></label><br>
		<input type="checkbox" name="WHEN_MANUALLY_RUN" value="Y" id="WHEN_MANUALLY_RUN"<?if($str_WHEN_MANUALLY_RUN=="Y")echo " checked"?>> <label for="WHEN_MANUALLY_RUN"><?echo GetMessage("MAIL_FLT_EDT_WHEN_MANUAL")?></label>
...
<?$tabControl->BeginNextTab();?>
	...
	<tr valign="top">
		...
		<select name="CONDITIONS[<?=htmlspecialchars($key)?>][TYPE]">
		...
		<select name="CONDITIONS[<?=htmlspecialchars($key)?>][COMPARE_TYPE]">
		...
		<td>
			<textarea name="CONDITIONS[<?=htmlspecialchars($key)?>][STRINGS]" style="width:70%" rows="3"><?echo htmlspecialchars($COND["STRINGS"])?></textarea><br>
		</td>
	</tr>
	<?endforeach?>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_COND_SPAM")?></td>
		<td>
	...
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_COND_SIZE")?></td>
		<td>
...
<?if($USER->IsAdmin()):?>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_COND_PHP")?></td>
...
<?endif?>
	...
	?>
		...
		<tr class="heading">
			...
			<?=htmlspecialchars($arModFilter["NAME"])?></td>
		</tr>
...
<?$tabControl->BeginNextTab();?>
	...
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_ACT_STATUS")?></td>
		<td>
	...
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_FLT_EDT_ACT_MARK")?></td>
		<td>
