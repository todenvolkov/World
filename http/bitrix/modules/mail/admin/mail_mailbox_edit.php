...
<?$tabControl->BeginNextTab();?>
	<?if($ID>0):?>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_MBOX_EDT_ID")?></td>
		<td><?echo $str_ID?></td>
	</tr>
	<?endif?>
	<?if(strlen($str_TIMESTAMP_X)>0):?>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_MBOX_EDT_DATECH")?></td>
		<td><?echo $str_TIMESTAMP_X?></td>
	</tr>
	<? endif; ?>
	<tr>
		<td valign="top" align="right"><?echo GetMessage("MAIL_MBOX_EDT_LANG")?> </td>
		<td valign="top">
	...
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_MBOX_EDT_ACT")?></td>
		<td><input type="checkbox" name="ACTIVE" value="Y"<?if($str_ACTIVE=="Y")echo " checked"?>></td>
	</tr>
	<tr valign="top">
		<td align="right"><span class="required">*</span><?echo GetMessage("MAIL_MBOX_EDT_NAME")?></td>
		<td><input type="text" name="NAME" size="53" maxlength="255" value="<?=$str_NAME?>"></td>
	</tr>
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_MBOX_EDT_DESC")?></td>
	...
	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_MBOX_SERVER_TYPE")?></td>
		<td>
	...
	<tr valign="top">
		<td align="right">
			<div id="pop7"><span class="required">*</span><?echo GetMessage("MAIL_MBOX_EDT_SERVER")?></div>
			<div id="smtp3"><span class="required">*</span><?echo GetMessage("MAIL_MBOX_SERVER_HOST")?><br><?echo GetMessage("MAIL_MBOX_SERVER_HOST_AST")?></div>
			</td>
...
setTimeout(chdom, 0);
	...
	<tr valign="top" id="smtp1">
		<td align="right"><?echo GetMessage("MAIL_MBOX_DOM")?><br> <?echo GetMessage("MAIL_MBOX_DOM_EMPTY")?></td>
		<td><textarea id="DOMAINS" name="DOMAINS" onkeyup="chdom()" cols="40" rows="4" onchange="chdom()"><?=$str_DOMAINS?></textarea></td>
	</tr>
	<tr valign="top" id="smtp2">
		<td align="right"></td>
		<td>
...
function change_port()
{
	...
	<tr valign="top" id="pop1">
		<td align="right"><?echo GetMessage("MAIL_MBOX_EDT_USE_TLS")?><span class="required"><sup>1</sup></span></td>
	...
	<tr valign="top" id="pop2">
		<td align="right"><span class="required">*</span><?echo GetMessage("MAIL_MBOX_EDT_LOGIN")?></td>
		<td><input type="text" name="LOGIN" size="53" maxlength="255" value="<?=$str_LOGIN?>"></td>
	</tr>
	<tr valign="top" id="pop3">
		<td align="right"><span class="required">*</span><?echo GetMessage("MAIL_MBOX_EDT_PASSWORD")?></td>
		<td><input type="password" name="PASSWORD" size="53" maxlength="255" value="<?=($MOD_RIGHT>="W"?$str_PASSWORD:"")?>"></td>
	</tr>
	<tr valign="top" id="pop4">
		<td align="right"><?echo GetMessage("MAIL_MBOX_EDT_USE_APOP")?></td>
		<td><input type="checkbox" name="USE_MD5" value="Y"<?if($str_USE_MD5=="Y")echo " checked"?>></td>
	</tr>
	<tr valign="top" id="pop5">
		<td align="right"><?echo GetMessage("MAIL_MBOX_EDT_DEL_AFTER_RETR")?></td>
		<td><input type="checkbox" name="DELETE_MESSAGES" value="Y"<?if($str_DELETE_MESSAGES=="Y")echo " checked"?>></td>
	</tr>
	<tr valign="top" id="pop6">
		<td width="40%" align="right"><?echo GetMessage("MAIL_MBOX_EDT_PERIOD")?></td>
		<td width="60%"><input type="text" name="PERIOD_CHECK" size="5" maxlength="18" value="<?echo $str_PERIOD_CHECK?>"> <?echo GetMessage("MAIL_MBOX_EDT_PERIOD_MIN")?></td>
	</tr>
...
<?$tabControl->BeginNextTab();?>
	...
	if(($db_max_allowed = $DB->Query("SHOW VARIABLES LIKE 'MAX_ALLOWED_PACKET'", true))!==false && ($ar_max_allowed = $db_max_allowed->Fetch())!==false && IntVal($ar_max_allowed["Value"])>0):
		...
		?>
			<tr valign="top">
				<td width="40%" align="right"><?echo GetMessage("MAIL_MBOX_EDT_MAX_ALLOWED")?></td>
				<td width="60%"><?echo $B_MAIL_MAX_ALLOWED/1024?> <?echo GetMessage("MAIL_MBOX_EDT_MAX_ALLOWED_KB")?></td>
			</tr>
			<?
	endif;
	?>
	...
	<tr valign="top">
		<td width="40%" align="right"><?echo GetMessage("MAIL_MBOX_EDT_MAX_MSGS")?></td>
	...
	<tr valign="top" id="pop8">
		<td width="40%" align="right"><?echo GetMessage("MAIL_MBOX_EDT_MAX_SIZE")?></td>
		<td width="60%"><input type="text" name="MAX_MSG_SIZE" size="5" maxlength="18" value="<?echo intval($str_MAX_MSG_SIZE/1024)?>"> <?echo GetMessage("MAIL_MBOX_EDT_MAX_SIZE_KB")?></td>
	</tr>


	<tr valign="top">
		<td width="40%" align="right"><?echo GetMessage("MAIL_MBOX_EDT_KEEP_DAYS")?></td>
		<td width="60%"><input type="text" name="MAX_KEEP_DAYS" size="5" maxlength="18" value="<?echo intval($str_MAX_KEEP_DAYS)?>"> <?echo GetMessage("MAIL_MBOX_EDT_KEEP_DAYS_D")?></td>
	</tr>

	<tr valign="top">
		<td align="right"><?echo GetMessage("MAIL_MBOX_EDT_CHARSET")?></td>
		<td><input type="text" name="CHARSET" id="CHARSET" size="12" maxlength="255" value="<?=$str_CHARSET?>"> <?echo GetMessage("MAIL_MBOX_EDT_CHARSET_RECOMND")?>
		<br>
<?
$chs = Array(
	"utf-8",
