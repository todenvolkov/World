...
include(GetLangFileName($_SERVER["DOCUMENT_ROOT"].BX_ROOT."/modules/mail/lang/", "/admin/mail_log.php"));
...
<tr>
	...
	<td nowrap><input type="text" name="find_message_subject" value="<?echo htmlspecialchars($find_message_subject)?>" size="47"><?=ShowFilterLogicHelp()?><br><input type="hidden" name="find_show_mess" value="N">
