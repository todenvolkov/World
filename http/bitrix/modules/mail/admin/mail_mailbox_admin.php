...
include(GetLangFileName($_SERVER["DOCUMENT_ROOT"].BX_ROOT."/modules/mail/lang/", "/admin/mail_mailbox_admin.php"));
...
<tr>
	...
	<td nowrap><?
		...
		echo SelectBoxFromArray("find_server_type", $arr, htmlspecialchars($find_server_type), GetMessage("MAIL_MBOX_ADM_FILT_ANY"));
		?></td>
</tr>

<tr>
	<td nowrap><?echo GetMessage("MAIL_MBOX_ADM_FILT_ADR")?></td>
	<td nowrap><input type="text" name="find_server" value="<?echo htmlspecialchars($find_server)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
...
<tr>
	...
	<td nowrap><?
		...
		echo SelectBoxFromArray("find_active", $arr, htmlspecialchars($find_active), GetMessage("MAIL_MBOX_ADM_FILT_ANY"));
		?></td>
</tr>
<tr>
