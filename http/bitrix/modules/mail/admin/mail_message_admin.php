...
$arHeaders[] = Array("id"=>"MESSAGE_SIZE", "content"=>GetMessage("MAIL_MSG_ADM_SIZE"), "default"=>true, "sort" => "size");
...
while($flt_arr = $res->Fetch())
	$arActions["refilter_num_".$flt_arr["ID"]] = GetMessage("MAIL_MSG_ADM_PROC_ACT_RULE")." ".htmlspecialchars(substr($flt_arr["NAME"], 0, 30));
...
<tr>
	...
	<td nowrap><input type="text" name="find_all" value="<?echo htmlspecialchars($find_all)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
...
<tr>
	...
	<td nowrap><input type="text" name="find_from" value="<?echo htmlspecialchars($find_from)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td nowrap><?echo GetMessage("MAIL_MSG_ADM_FILTER_TO")?>:</td>
	<td nowrap><input type="text" name="find_to" value="<?echo htmlspecialchars($find_to)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td nowrap><?echo GetMessage("MAIL_MSG_ADM_FILTER_SUBJECT")?>:</td>
	<td nowrap><input type="text" name="find_subject" value="<?echo htmlspecialchars($find_subject)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td nowrap><?echo GetMessage("MAIL_MSG_ADM_FILTER_TEXT")?>:</td>
	<td nowrap><input type="text" name="find_body" value="<?echo htmlspecialchars($find_body)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
