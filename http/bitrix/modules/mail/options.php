...
##############################################
global $MESS;
include(GetLangFileName($GLOBALS["DOCUMENT_ROOT"]."/bitrix/modules/mail/lang/", "/options.php"));
...
setTimeout("Stats()", 0);
	...
	<tr>
		...
		<td valign="middle" width="50%">
			<input type="text" id="php_path" size="35" maxlength="255" value="<?=htmlspecialchars($val)?>" name="php_path"></td>
	</tr>
