...
if(strlen($arParams['PATH_TO_CATEGORY'])<=0)
	$arParams['PATH_TO_CATEGORY'] = htmlspecialchars($APPLICATION->GetCurPage()."?$arParams[PAGE_VAR]=#wiki_name#");	
...
{	        
	...
	$arResult['PATH_TO_HISTORY_DIFF'] = CHTTP::urlAddParams(
		CComponentEngine::MakePathFromTemplate($arParams['PATH_TO_HISTORY_DIFF'], 
			array(
	...
	{   
		...
		$arHistory['USER_LOGIN'] = CWikiUtils::GetUserLogin($arHistory);
