...
if($MOD_RIGHT>='R'):
	...
	if(IsModuleInstalled('forum')) {
		...
		$arForumOptions =	Array(		
			...
			array('socnet_message_per_page', GetMessage('WIKI_OPTIONS_SOCNET_MESSAGE_PER_PAGE'), '20', Array('text')),
...
if(IsModuleInstalled('socialnetwork'))
{
	...
	<tr>
		...
		<td><?echo GetIBlockDropDownList($socnet_iblock_id, 'socnet_iblock_type_id', 'socnet_iblock_id');?></td>
	</tr>
	<? 	
	if(IsModuleInstalled('forum'))
	{ 		    
