...
{
	global $strError, $arFilterFields, $DB;
	...
	foreach($arr as $ar)
	{
		...
		elseif (strlen($ar["date1"])>0 && strlen($ar["date2"])>0 && $DB->CompareDates($ar["date1"], $ar["date2"])==1)
...
<tr>
	...
	<td><input type="text" name="find_user" size="30" value="<?echo htmlspecialchars($find_user)?>"><?=ShowExactMatchCheckbox("find_user")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>

<tr>
	<td><?echo GetMessage("STAT_F_ID")?>:</td>
	<td><input type="text" name="find_id" size="30" value="<?echo htmlspecialchars($find_id)?>"><?=ShowExactMatchCheckbox("find_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_START_DATE")." (".CLang::GetDateFormat("SHORT")."):"?></td>
	<td width="0%" nowrap><?echo CalendarPeriod("find_date1", $find_date1, "find_date2", $find_date2, "form1","Y")?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_DATE_END")." (".CLang::GetDateFormat("SHORT")."):"?></td>
...
<tr>
	...
	<td><input type="text" name="find_guest_id" size="30" value="<?echo htmlspecialchars($find_guest_id)?>"><?=ShowExactMatchCheckbox("find_guest_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
...
<tr>
	...
	<td>
		...
		echo SelectBoxFromArray("find_registered", $arr, htmlspecialchars($find_registered), GetMessage("MAIN_ALL"));
		?></td>
</tr>
<tr>
	...
	<td><?
		...
		echo SelectBoxFromArray("find_new_guest", $arr, htmlspecialchars($find_new_guest), GetMessage("MAIN_ALL"));
		?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_IP")?>:</td>
	<td><input type="text" name="find_ip" size="30" value="<?echo htmlspecialchars($find_ip)?>"><?=ShowExactMatchCheckbox("find_ip")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td valign="top"><?echo GetMessage("STAT_F_USER_AGENT")?>:</td>
	<td><textarea class="typearea" name="find_user_agent" cols="30" rows="5"><?echo htmlspecialchars($find_user_agent)?></textarea><?=ShowExactMatchCheckbox("find_user_agent")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_COUNTRY")?>:</td>
	<td valign="center">
		[&nbsp;<input type="text" name="find_country_id" size="5" value="<?echo htmlspecialchars($find_country_id)?>">&nbsp;]&nbsp;&nbsp;&nbsp;<input type="text" name="find_country" size="30" value="<?echo htmlspecialchars($find_country)?>"><?echo ShowExactMatchCheckbox("find_country")?>&nbsp;<?echo ShowFilterLogicHelp()?>
	</td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_REGION")?>:</td>
	<td><input type="text" name="find_region" size="50" value="<?echo htmlspecialchars($find_region)?>"><?echo ShowExactMatchCheckbox("find_region")?>&nbsp;<?echo ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_CITY")?>:</td>
	<td valign="center">
		[&nbsp;<input type="text" name="find_city_id" size="5" value="<?echo htmlspecialchars($find_city_id)?>">&nbsp;]&nbsp;&nbsp;&nbsp;<input type="text" name="find_city" size="30" value="<?echo htmlspecialchars($find_city)?>"><?echo ShowExactMatchCheckbox("find_city")?>&nbsp;<?echo ShowFilterLogicHelp()?>
	</td>
</tr>
<tr>
	...
	<td><?
		$arr = array("reference"=>array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id"=>array("Y","N"));
		echo SelectBoxFromArray("find_stop", $arr, htmlspecialchars($find_stop), GetMessage("MAIN_ALL"));
		?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_STOP_LIST_ID")?>:</td>
	<td><input type="text" name="find_stop_list_id" size="30" value="<?echo htmlspecialchars($find_stop_list_id)?>"><?=ShowExactMatchCheckbox("find_stop_list_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>
		<?echo GetMessage("STAT_F_HITS")?>:</td>
	<td>
		<input type="text" name="find_hits1" size="10" value="<?echo htmlspecialchars($find_hits1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_hits2" size="10" value="<?echo htmlspecialchars($find_hits2)?>"></td>
</tr>
<tr>
	<td>
		<?echo GetMessage("STAT_F_EVENTS")?>:</td>
	<td>
		<input type="text" name="find_events1" size="10" value="<?echo htmlspecialchars($find_events1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_events2" size="10" value="<?echo htmlspecialchars($find_events2)?>"></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_CAME_ADV")?>:</td>
	<td><?
		$arr = array("reference"=>array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id"=>array("Y","N"));
		echo SelectBoxFromArray("find_adv", $arr, htmlspecialchars($find_adv), GetMessage("MAIN_ALL"));
		?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_ADV")?>:</td>
	<td><input type="text" name="find_adv_id" size="30" value="<?echo htmlspecialchars($find_adv_id)?>"><?=ShowExactMatchCheckbox("find_adv_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_REFERER12")?>:</td>
	<td><input type="text" name="find_referer1" size="14" value="<?echo htmlspecialchars($find_referer1)?>">&nbsp;/&nbsp;<input type="text" name="find_referer2" size="14" value="<?echo htmlspecialchars($find_referer2)?>"><?=ShowExactMatchCheckbox("find_referer12")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_REFERER3")?>:</td>
	<td><input type="text" name="find_referer3" size="30" value="<?echo htmlspecialchars($find_referer3)?>"><?=ShowExactMatchCheckbox("find_referer3")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>
	...
	<td>
		<?
		$arr = array("reference"=>array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id"=>array("Y","N"));
		echo SelectBoxFromArray("find_adv_back", $arr, htmlspecialchars($find_adv_back), GetMessage("MAIN_ALL"));
		?></td>
</tr>
<tr>
	...
	?>&nbsp;<?
		echo SelectBoxFromArray("find_url_to_404", array("reference"=>array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id"=>array("Y","N")), htmlspecialchars($find_url_to_404), GetMessage("STAT_404"));
	?>&nbsp;<input type="text" name="find_url_to" size="34" value="<?echo htmlspecialchars($find_url_to)?>"><?=ShowExactMatchCheckbox("find_url_to")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	...
	?>&nbsp;<?
		echo SelectBoxFromArray("find_url_last_404", array("reference"=>array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id"=>array("Y","N")), htmlspecialchars($find_url_last_404), GetMessage("STAT_404"));
	?>&nbsp;<input type="text" name="find_url_last" size="34" value="<?echo htmlspecialchars($find_url_last)?>"><?=ShowExactMatchCheckbox("find_url_last")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<?=ShowLogicRadioBtn()?>
