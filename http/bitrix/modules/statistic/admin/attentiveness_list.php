...
?>
	<h2><?=GetMessage("STAT_TIME_GRAPH")?></h2>
	<div class="graph">
	...
	<h2><?=GetMessage("STAT_TIME_DIAGRAM")?></h2>
	<div class="graph">
	<table cellspacing=0 cellpadding="0" border="0" class="graph"><tr>
		<td valign="top" class="graph">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" border="0" class="legend">
				...
				<tr>
					...
					<td align="right" nowrap>(<?=$arSum[$key]?>)</td>
...
<?else:?>
	<h2><?=GetMessage("STAT_HITS_GRAPH")?></h2>
	<div class="graph">
	<table cellspacing="0" cellpadding="0" class="graph" border="0"><tr>
		<td valign="top" class="graph">
	...
	<h2><?=GetMessage("STAT_HITS_DIAGRAM")?></h2>
	<div class="graph">
	<table cellspacing="0" cellpadding="0" border="0" class="graph"><tr>
		<td valign="top" class="graph">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" border="0" class="legend">
				...
				<tr>
					...
					<td align="right" nowrap><?echo sprintf("%01.2f", $procent)."%"?></td>
					<td align="right" nowrap>(<a href="/bitrix/admin/session_list.php?find_hits1=<?=$hits1?>&find_hits2=<?=$hits2?>&set_filter=Y"><?echo $arSum[$key]?></a>)</td>
					<td nowrap><?echo GetMessage("STAT_".$key);?></td>
				</tr>
				<?endforeach;?>
			</table>
