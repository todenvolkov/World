...
while($arRes = $rsData->NavNext(true, "f_")):
	...
	$row->AddViewField("SELECT_BUTTON","<a href=\"".htmlspecialchars("javascript:setTargetValue('".$id."', '".$fld."');")."\" title=\"".GetMessage("STAT_CHOOSE_TITLE")."\">".GetMessage("STAT_CHOOSE")."</a>");
	...
	if($target_control=="text")
	{
		$arActions = array(
			array(
				...
				"ACTION"=>htmlspecialchars("javascript:setTargetValue('".$id."', '".$fld."');"),
			),
		);
...
if($target_control!="text")
{
	$lAdmin->AddGroupActionTable(array(
		array(
			"action" => htmlspecialchars("setTargetValue(0, '".CUtil::JSEscape($field)."')"),
			"value" => "select",
			"type" => "button",
