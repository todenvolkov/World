...
)
{
	$aMenu = Array(
		...
		array(
			...
			"url" => "traffic.php?lang=".LANGUAGE_ID."&amp;set_default=Y",
			"more_url" => array("traffic.php"),
			...
			"items" => array(
				array(
					...
					"more_url"=>array("traffic.php?graph_type=date"),
				...
				Array(
					...
					"items" => array(
						Array(
							...
							"url" => "event_type_list.php?lang=".LANGUAGE_ID,
							"more_url" => array("event_type_list.php"),
							"title" => GetMessage("STATM_EVENT_TYPE_ALT"),
						),
						Array(
		...
		array(
			...
			//&menu_item_id=1 hacks menu item selection algorithm
			//in a way to correctly select Internal Searcher item
			"url" => "phrase_list.php?lang=".LANGUAGE_ID.'&amp;group_by=none&amp;set_default=Y&amp;menu_item_id=1',
