...
<tr>
	...
	<td><input type="text" name="find_searcher" size="67" value="<?echo htmlspecialchars($find_searcher)?>"><?=ShowExactMatchCheckbox("find_searcher")?>&nbsp;<?=ShowFilterLogicHelp()?><br><?echo SelectBox("find_searcher_id", CSearcher::GetDropDownList(), GetMessage("MAIN_ALL"), htmlspecialchars($find_searcher_id));?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_ID")?></td>
	<td><input type="text" name="find_id" size="67" value="<?echo htmlspecialchars($find_id)?>"><?=ShowExactMatchCheckbox("find_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_user_agent" size="67" value="<?echo htmlspecialchars($find_user_agent)?>"><?=ShowExactMatchCheckbox("find_user_agent")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_IP")?></td>
	<td><input type="text" name="find_ip" size="67" value="<?echo htmlspecialchars($find_ip)?>"><?=ShowExactMatchCheckbox("find_ip")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<?=ShowLogicRadioBtn()?>
<?
