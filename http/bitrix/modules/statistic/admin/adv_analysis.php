...
while($ar = $rs->Fetch())
{
	$arrEVENT[$ar["ID"]] = htmlspecialchars($ar["EVENT"])." [".$ar["ID"]."]";
}
...
?>
<h2><?echo $arrParams[$find_data_type][1]?></h2>
<div class="graph">
...
<tr>
	...
	<td><input type="text" name="find_adv_id" size="35" value="<?echo htmlspecialchars($find_adv_id)?>"><?=ShowExactMatchCheckbox("find_adv_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>referer1:</td>
	<td><input type="text" name="find_referer1" size="35" value="<?echo htmlspecialchars($find_referer1)?>"><?=ShowExactMatchCheckbox("find_referer1")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>referer2:</td>
	<td><input type="text" name="find_referer2" size="35" value="<?echo htmlspecialchars($find_referer2)?>"><?=ShowExactMatchCheckbox("find_referer2")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
...
<tr>
	...
	<td><input type="text" name="find_event_type_id" size="35" value="<?echo htmlspecialchars($find_event_type_id)?>"><?=ShowExactMatchCheckbox("find_event_type_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>event1:</td>
	<td><input type="text" name="find_event1" size="35" value="<?echo htmlspecialchars($find_event1)?>"><?=ShowExactMatchCheckbox("find_event1")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>event2:</td>
	<td><input type="text" name="find_event2" size="35" value="<?echo htmlspecialchars($find_event2)?>"><?=ShowExactMatchCheckbox("find_event2")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
