	...
	if($group_by=="")
	{
		...
		if($STAT_RIGHT>="W")
			$arActions[] = array(
				...
				"ACTION"=>"if(confirm('".GetMessage('STAT_RESET_CONFIRM')."')) ".$lAdmin->ActionDoGroup($f_ID, "clear")
			);
		if($STAT_RIGHT>="W")
			$arActions[] = array(
				"ICON"=>"delete",
				...
				"ACTION"=>"if(confirm('".GetMessage('STAT_CONFIRM')."')) ".$lAdmin->ActionDoGroup($f_ID, "delete")
			);
...
<tr>
	...
	<td>
		<input type="text" size="25" name="find" value="<?echo htmlspecialchars($find)?>" title="<?=GetMessage("STAT_FIND_TITLE")?>">
		<?
		$arr = array(
			"reference" => array(
				"referer1",
...
<tr>
	...
	<td><input type="text" name="find_referer1" size="9" value="<?echo htmlspecialchars($find_referer1)?>">&nbsp;&nbsp;/&nbsp;&nbsp;<input class="typeinput" type="text" name="find_referer2" size="9" value="<?echo htmlspecialchars($find_referer2)?>"><?=ShowExactMatchCheckbox("find_referer12")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_DURATION")?>:</td>
	<td><input type="text" maxlength="10" name="find_duration1" value="<?echo htmlspecialchars($find_duration1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?>&nbsp;<input type="text" maxlength="10" name="find_duration2" value="<?echo htmlspecialchars($find_duration2)?>" size="9"></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_SESSIONS")?>:</td>
	<td><input type="text" maxlength="10" name="find_sessions1" value="<?echo htmlspecialchars($find_sessions1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?>&nbsp;<input type="text" maxlength="10" name="find_sessions2" value="<?echo htmlspecialchars($find_sessions2)?>" size="9">&nbsp;<?=GetMessage("STAT_F_BACK")?>&nbsp;<?echo InputType("checkbox","find_sessions_back","Y",$find_sessions_back,false)?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_GUESTS")?>:</td>
	<td><input type="text" maxlength="10" name="find_guests1" value="<?echo htmlspecialchars($find_guests1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?>&nbsp;<input type="text" maxlength="10" name="find_guests2" value="<?echo htmlspecialchars($find_guests2)?>" size="9">&nbsp;<?=GetMessage("STAT_F_BACK")?>&nbsp;<?echo InputType("checkbox","find_guests_back","Y",$find_guests_back,false) ?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" maxlength="10" name="find_attent1" value="<?echo htmlspecialchars($find_attent1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?>&nbsp;<input type="text" maxlength="10" name="find_attent2" value="<?echo htmlspecialchars($find_attent2)?>" size="9">&nbsp;<?=GetMessage("STAT_F_BACK")?>&nbsp;<?echo InputType("checkbox","find_attent_back","Y",$find_attent_back,false) ?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_VISITORS_PER_DAY")?>:</td>
	<td><input type="text" maxlength="10" name="find_visitors_per_day1" value="<?echo htmlspecialchars($find_visitors_per_day1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?>&nbsp;<input type="text" maxlength="10" name="find_visitors_per_day2" value="<?echo htmlspecialchars($find_visitors_per_day2)?>" size="9"></td>
</tr>
<?if ($STAT_RIGHT>"M"):?>
<tr>
	<td><?echo GetMessage("STAT_F_COST")?>:</td>
	<td><input type="text" maxlength="10" name="find_cost1" value="<?echo htmlspecialchars($find_cost1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?>&nbsp;<input type="text" maxlength="10" name="find_cost2" value="<?echo htmlspecialchars($find_cost2)?>" size="9"></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_REVENUE")?>:</td>
	<td><input type="text" maxlength="10" name="find_revenue1" value="<?echo htmlspecialchars($find_revenue1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?>&nbsp;<input type="text" maxlength="10" name="find_revenue2" value="<?echo htmlspecialchars($find_revenue2)?>" size="9"></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_BENEFIT")?>:</td>
	<td><input type="text" maxlength="10" name="find_benefit1" value="<?echo htmlspecialchars($find_benefit1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?><input type="text" maxlength="10" name="find_benefit2" value="<?echo htmlspecialchars($find_benefit2)?>" size="9"></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_ROI")?>:</td>
	<td><input type="text" maxlength="10" name="find_roi1" value="<?echo htmlspecialchars($find_roi1)?>" size="9">&nbsp;<?echo GetMessage("STAT_TILL")?><input type="text" maxlength="10" name="find_roi2" value="<?echo htmlspecialchars($find_roi2)?>" size="9"></td>
</tr>
<?if ($currency_module=="Y") : ?>
<tr>
	<td><?echo GetMessage("STAT_F_CURRENCY")?>:</td>
	<td><?
	echo SelectBoxFromArray("find_currency", $arrCurrency, htmlspecialchars($find_currency), GetMessage("STAT_F_BASE_CURRENCY"));?></td>
</tr>
<?endif;?>
<?endif;?>
<?
