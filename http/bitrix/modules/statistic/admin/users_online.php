...
$lAdmin->onLoadScript = "jsUtils.SetPageTitle('".addslashes($s)."');";
...
<tr>
	...
	<td valign="center">
		<table cellspacing=0 cellpadding=0>
			<tr>
				<td valign="top">[&nbsp;</td>
				<td><input type="text" name="find_country_id" size="5" value="<?echo htmlspecialchars($find_country_id)?>"></td>
				<td valign="top">&nbsp;]&nbsp;&nbsp;&nbsp;</td>
				<td><input type="text" name="find_country" size="30" value="<?echo htmlspecialchars($find_country)?>"><?=ShowExactMatchCheckbox("find_country")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
			</tr>
		</table></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_first_from" size="34" value="<?echo htmlspecialchars($find_first_from)?>"><?=ShowExactMatchCheckbox("find_first_from")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
