...
if($STAT_RIGHT>"M")
	$arHeaders[]=
		array(	"id"		=>"MONEY",
			"content"	=>GetMessage("STAT_MONEY").(strlen($view_currency)>0?"<br>(".$view_currency.")":""),
			"sort"		=>"s_money",
			"align"		=>"right",
			"default"	=>true,
		);
...
<tr>
	...
	<td>
		<input type="text" size="25" name="find" value="<?echo htmlspecialchars($find)?>" title="<?=GetMessage("STAT_F_FIND_ENTER")?>">
		<?
		$arr = array(
			"reference" => array(
				"event1",
...
<tr>
	...
	<td><input type="text" name="find_event_id" size="47" value="<?echo htmlspecialchars($find_event_id)?>"><?=ShowExactMatchCheckbox("find_event_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_EVENT_TYPE_NAME")?>:</td>
	<td><input type="text" name="find_event_name" size="47" value="<?echo htmlspecialchars($find_event_name)?>"><?=ShowExactMatchCheckbox("find_event_name")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>event1 / event2:</td>
	<td><input type="text" name="find_event1" size="14" value="<?echo htmlspecialchars($find_event1)?>">&nbsp;/&nbsp;<input type="text" name="find_event2" size="14" value="<?echo htmlspecialchars($find_event2)?>"><?=ShowExactMatchCheckbox("find_event12")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>event3:</td>
	<td><input type="text" name="find_event3" size="47" value="<?echo htmlspecialchars($find_event3)?>"><?=ShowExactMatchCheckbox("find_event3")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_session_id" size="47" value="<?echo htmlspecialchars($find_session_id)?>"><?=ShowExactMatchCheckbox("find_session_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_GUEST_ID")?>:</td>
	<td><input type="text" name="find_guest_id" size="47" value="<?echo htmlspecialchars($find_guest_id)?>"><?=ShowExactMatchCheckbox("find_guest_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_COUNTRY")?>:</td>
	<td>[&nbsp;<input type="text" name="find_country_id" size="5" value="<?echo htmlspecialchars($find_country_id)?>">&nbsp;]&nbsp;&nbsp;&nbsp;<input type="text" name="find_country" size="34" value="<?echo htmlspecialchars($find_country)?>"><?=ShowExactMatchCheckbox("find_country")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_ADV_ID")?>:</td>
	<td><input type="text" name="find_adv_id" size="47" value="<?echo htmlspecialchars($find_adv_id)?>"><?=ShowExactMatchCheckbox("find_adv_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_hit_id" size="47" value="<?echo htmlspecialchars($find_hit_id)?>"><?=ShowExactMatchCheckbox("find_hit_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	...
	?>&nbsp;<input type="text" name="find_referer_url" size="34" value="<?echo htmlspecialchars($find_referer_url)?>"><?=ShowExactMatchCheckbox("find_referer_url")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_URL")?>:</td>
	<td><?
		echo SelectBoxFromArray("find_site_id", $arSiteDropdown, $find_site_id, GetMessage("STAT_D_SITE"));
	?>&nbsp;<input type="text" name="find_url" size="34" value="<?echo htmlspecialchars($find_url)?>"><?=ShowExactMatchCheckbox("find_url")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_REDIRECT_URL")?>:</td>
	<td><input type="text" name="find_redirect_url" size="47" value="<?echo htmlspecialchars($find_redirect_url)?>"><?=ShowExactMatchCheckbox("find_redirect_url")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<?if($STAT_RIGHT>"M"):?>
<tr>
	<td><?echo GetMessage("STAT_F_MONEY")?>:</td>
	<td><input type="text" maxlength="10" name="find_money1" value="<?echo htmlspecialchars($find_money1)?>" size="9"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" maxlength="10" name="find_money2" value="<?echo htmlspecialchars($find_money2)?>" size="9"></td>
</tr>
<?if ($currency_module=="Y") : ?>
<tr>
