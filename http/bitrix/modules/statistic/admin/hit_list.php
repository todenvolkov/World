...
<tr>
	...
	<td><input type="text" name="find_session_id" size="30" value="<?echo htmlspecialchars($find_session_id)?>"><?=ShowExactMatchCheckbox("find_session_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_DATE")." (".CLang::GetDateFormat("SHORT")."):"?></td>
...
<tr>
	...
	<td valign="center">
		[&nbsp;<input type="text" name="find_country_id" size="5" value="<?echo htmlspecialchars($find_country_id)?>">&nbsp;]&nbsp;&nbsp;&nbsp;<input type="text" name="find_country" size="50" value="<?echo htmlspecialchars($find_country)?>"><?echo ShowExactMatchCheckbox("find_country")?>&nbsp;<?echo ShowFilterLogicHelp()?>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td valign="center">
		[&nbsp;<input type="text" name="find_city_id" size="5" value="<?echo htmlspecialchars($find_city_id)?>">&nbsp;]&nbsp;&nbsp;&nbsp;<input type="text" name="find_city" size="50" value="<?echo htmlspecialchars($find_city)?>"><?echo ShowExactMatchCheckbox("find_city")?>&nbsp;<?echo ShowFilterLogicHelp()?>
	</td>
</tr>
<tr>
...
<tr>
	<td>Cookie:</td>
	<td><input type="text" name="find_cookie" size="30" value="<?echo htmlspecialchars($find_cookie)?>"><?=ShowExactMatchCheckbox("find_cookie")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
