...
<tr>
	...
	<td align="right"><a href="hit_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $now_date?>&amp;find_date2=<?echo $now_date?>&amp;set_filter=Y"><?echo $arComm["TODAY_HITS"]?></a></td>
	<td align="right"><a href="hit_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $yesterday_date?>&amp;find_date2=<?echo $yesterday_date?>&amp;set_filter=Y"><?echo $arComm["YESTERDAY_HITS"]?></a></td>
	<td align="right"><a href="hit_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $bef_yesterday_date?>&amp;find_date2=<?echo $bef_yesterday_date?>&amp;set_filter=Y"><?echo $arComm["B_YESTERDAY_HITS"]?></a></td>
	<?if ($is_filtered) : ?>
		<td align="right"><a href="hit_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $find_date1?>&amp;find_date2=<?echo $find_date2?>&amp;set_filter=Y"><?echo $arComm["PERIOD_HITS"]?></td>
	<?endif;?>
	<td align="right"><a href="hit_list.php?lang=<?=LANG?>&amp;del_filter=Y"><?echo $arComm["TOTAL_HITS"]?></a></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_HOSTS")?></td>
	<td align="right"><?echo $arComm["TODAY_HOSTS"]?></td>
	<td align="right"><?echo $arComm["YESTERDAY_HOSTS"]?></td>
	<td align="right"><?echo $arComm["B_YESTERDAY_HOSTS"]?></td>
	<?if ($is_filtered) : ?>
		<td align="right">&nbsp;</td>
	<?endif;?>
	<td align="right"><?echo $arComm["TOTAL_HOSTS"]?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_SESSIONS")?></td>
	<td align="right"><a href="session_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $now_date?>&amp;find_date2=<?echo $now_date?>&amp;set_filter=Y"><?echo $arComm["TODAY_SESSIONS"]?></a></td>
	<td align="right"><a href="session_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $yesterday_date?>&amp;find_date2=<?echo $yesterday_date?>&amp;set_filter=Y"><?echo $arComm["YESTERDAY_SESSIONS"]?></a></td>
	<td align="right"><a href="session_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $bef_yesterday_date?>&amp;find_date2=<?echo $bef_yesterday_date?>&amp;set_filter=Y"><?echo $arComm["B_YESTERDAY_SESSIONS"]?></a></td>
	<?if ($is_filtered) : ?>
		<td align="right"><a href="session_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $find_date1?>&amp;find_date2=<?echo $find_date2?>&amp;set_filter=Y"><?echo $arComm["PERIOD_SESSIONS"]?></a></td>
	<?endif;?>
	<td align="right"><a href="session_list.php?lang=<?=LANG?>&amp;del_filter=Y"><?echo $arComm["TOTAL_SESSIONS"]?></a></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_C_EVENTS")?></td>
	<td align="right"><a href="event_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $now_date?>&amp;find_date2=<?echo $now_date?>&amp;set_filter=Y"><?echo $arComm["TODAY_EVENTS"]?></a></td>
	<td align="right"><a href="event_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $yesterday_date?>&amp;find_date2=<?echo $yesterday_date?>&amp;set_filter=Y"><?echo $arComm["YESTERDAY_EVENTS"]?></a></td>
	<td align="right"><a href="event_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $bef_yesterday_date?>&amp;find_date2=<?echo $bef_yesterday_date?>&amp;set_filter=Y"><?echo $arComm["B_YESTERDAY_EVENTS"]?></a></td>
	<?if ($is_filtered) : ?>
		<td align="right"><a href="event_list.php?lang=<?=LANG?>&amp;find_date1=<?echo $find_date1?>&amp;find_date2=<?echo $find_date2?>&amp;set_filter=Y"><?echo $arComm["PERIOD_EVENTS"]?></a></td>
	<?endif;?>
	<td align="right"><a href="event_list.php?lang=<?=LANG?>&amp;del_filter=Y"><?echo $arComm["TOTAL_EVENTS"]?></a></td>
</tr>
<?if ($site_filter!="Y"):?>
<tr class="heading">
...
<tr>
	...
	<td align="right"><a href="guest_list.php?lang=<?=LANG?>&amp;find_last_date1=<?echo $now_date?>&amp;find_last_date2=<?echo $now_date?>&amp;set_filter=Y"><?echo $arComm["TODAY_GUESTS"]?></a></td>
	<td align="right"><a href="guest_list.php?lang=<?=LANG?>&amp;find_period_date1=<?echo $yesterday_date?>&amp;find_period_date2=<?echo $yesterday_date?>&amp;set_filter=Y"><?echo $arComm["YESTERDAY_GUESTS"]?></a></td>
	<td align="right"><a href="guest_list.php?lang=<?=LANG?>&amp;find_period_date1=<?echo $bef_yesterday_date?>&amp;find_period_date2=<?echo $bef_yesterday_date?>&amp;set_filter=Y"><?echo $arComm["B_YESTERDAY_GUESTS"]?></a></td>
	<?if($is_filtered):?>
		<td align="right">&nbsp;</td>
	<?endif;?>
	<td align="right"><a href="guest_list.php?lang=<?=LANG?>&amp;del_filter=Y"><?echo $arComm["TOTAL_GUESTS"]?></a></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_NEW")?></td>
	<td align="right"><a href="guest_list.php?lang=<?=LANG?>&amp;find_period_date1=<?echo $now_date?>&amp;find_period_date2=<?echo $now_date?>&amp;find_sess2=1&amp;set_filter=Y"><?echo $arComm["TODAY_NEW_GUESTS"]?></a></td>
	<td align="right"><a href="guest_list.php?lang=<?=LANG?>&amp;find_period_date1=<?echo $yesterday_date?>&amp;find_period_date2=<?echo $yesterday_date?>&amp;find_sess2=1&amp;set_filter=Y"><?echo $arComm["YESTERDAY_NEW_GUESTS"]?></a></td>
	<td align="right"><a href="guest_list.php?lang=<?=LANG?>&amp;find_period_date1=<?echo $bef_yesterday_date?>&amp;find_period_date2=<?echo $bef_yesterday_date?>&amp;find_sess2=1&amp;set_filter=Y"><?echo $arComm["B_YESTERDAY_NEW_GUESTS"]?></a></td>
	<?if($is_filtered):?>
		<td align="right"><a href="guest_list.php?lang=<?=LANG?>&amp;find_period_date1=<?echo $find_date1?>&amp;find_period_date2=<?echo $find_date2?>&amp;find_sess2=1&amp;set_filter=Y"><?echo $arComm["PERIOD_NEW_GUESTS"]?></a></td>
	<?endif;?>
	<td align="right">&nbsp;</td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_ONLINE")?></td>
	<td align="right"><a href="users_online.php?lang=<?=LANG?>"><?echo $arComm["ONLINE_GUESTS"]?></a></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<?if($is_filtered):?>
		<td>&nbsp;</td>
...
<tr class="heading" valign="top">
	...
	<?if ($is_filtered) : ?>
		<td><a href="session_list.php?lang=<?=LANG?>&amp;find_date1=<?=htmlspecialchars($find_date1)?>&amp;find_date2=<?=htmlspecialchars($find_date2)?>&amp;find_adv_back=N&amp;set_filter=Y"><?=GetMessage("STAT_PERIOD")?></a><br><?=$arFilter["DATE1"]?>&nbsp;- <?=$arFilter["DATE2"]?></td>
	<?endif;?>
...
<?if ($is_filtered) : ?>
	<td align="right">
		<?if (intval($f_SESSIONS_PERIOD)>0) :?>
			<a href="session_list.php?lang=<?=LANG?>&amp;find_date1=<?echo htmlspecialchars($find_date1)?>&amp;find_date2=<?echo htmlspecialchars($find_date2)?>&amp;find_adv_id=<?echo $f_ID?>&amp;find_adv_id_exact_match=Y&amp;find_adv_back=N&amp;set_filter=Y"><?echo $f_SESSIONS_PERIOD?></a>
		<?else:?>
			&nbsp;
		<?endif;?>
	</td>
...
endwhile;?>
<tr>
	<td align="right"><?echo GetMessage("STAT_TOTAL")?></td>
	<td align="right">
...
<?if ($is_filtered) : ?>
	<td><a href="event_list.php?lang=<?=LANG?>&amp;find_date1=<?=htmlspecialchars($find_date1)?>&amp;find_date2=<?=htmlspecialchars($find_date2)?>&amp;set_filter=Y"><?=GetMessage("STAT_PERIOD")?></a><br><?=$arFilter["DATE1"]?>&nbsp;- <?=$arFilter["DATE2"]?></td>
<?endif;?>
...
<?if($is_filtered):?>
	<td align="right">
		<?if (intval($e_PERIOD_COUNTER)>0):?>
			<a href="event_list.php?lang=<?=LANG?>&amp;find_date1=<?echo htmlspecialchars($find_date1)?>&amp;find_date2=<?echo htmlspecialchars($find_date2)?>&amp;find_event_id=<?echo $e_ID?>&amp;find_event_id_exact_match=Y&amp;set_filter=Y"><?echo $e_PERIOD_COUNTER?></a>
		<?else:?>
			&nbsp;
		<?endif;?>
	</td>
...
<tr>
	<td align="right"><?echo GetMessage("STAT_TOTAL")?></td>
	<td align="right"><?=(intval($total_TODAY_COUNTER)>0?$total_TODAY_COUNTER:'&nbsp;')?></td>
	<td align="right"><?=(intval($total_YESTERDAY_COUNTER)>0?$total_YESTERDAY_COUNTER:'&nbsp;')?></td>
	<td align="right"><?=(intval($total_B_YESTERDAY_COUNTER)>0?$total_B_YESTERDAY_COUNTER:'&nbsp;')?></td>
<?if($is_filtered):?>
	<td align="right"><?=(intval($total_PERIOD_COUNTER)>0?$total_PERIOD_COUNTER:'&nbsp;')?></td>
<?endif;?>
	<td align="right"><?=(intval($total_TOTAL_COUNTER)>0?$total_TOTAL_COUNTER:'&nbsp;')?></td>
</tr>
...
<?if($is_filtered):?>
	<td><a href="referer_list.php?lang=<?=LANG?>&amp;find_date1=<?=htmlspecialchars($find_date1)?>&amp;find_date2=<?=htmlspecialchars($find_date2)?>&amp;group_by=none&amp;set_filter=Y"><?=GetMessage("STAT_PERIOD")?></a><br> <?=$arFilter["DATE1"]?>&nbsp;- <?=$arFilter["DATE2"]?></td>
<?endif;?>
...
<?if($is_filtered):?>
	<td align="right">
		<?if(intval($t_PERIOD_REFERERS)>0):?>
			<a href="referer_list.php?lang=<?=LANG?>&amp;find_date1=<?echo htmlspecialchars($find_date1)?>&amp;find_date2=<?echo htmlspecialchars($find_date2)?>&amp;find_from=<?echo urlencode("\"".$SITE_NAME."\"")?>&amp;set_filter=Y"><?echo $t_PERIOD_REFERERS?></a>
		<?else:?>
			&nbsp;
		<?endif;?>
	</td>
...
<tr>
	<td align="right"><?echo GetMessage("STAT_TOTAL")?></td>
	<td align="right"><?=(intval($total_TODAY_REFERERS)>0?$total_TODAY_REFERERS:'&nbsp;')?></td>
	<td align="right"><?=(intval($total_YESTERDAY_REFERERS)>0?$total_YESTERDAY_REFERERS:'&nbsp;')?></td>
	<td align="right"><?=(intval($total_B_YESTERDAY_REFERERS)>0?$total_B_YESTERDAY_REFERERS:'&nbsp;')?></td>
<?if($is_filtered):?>
	<td align="right"><?=(intval($total_PERIOD_REFERERS)>0?$total_PERIOD_REFERERS:'&nbsp;')?></td>
<?endif;?>
	<td align="right"><?=(intval($total_TOTAL_REFERERS)>0?$total_TOTAL_REFERERS:'&nbsp;')?></td>
</tr>
</table>
<?
endif;
...
<?if($is_filtered):?>
	<td><a href="phrase_list.php?lang=<?=LANG?>&amp;find_date1=<?=htmlspecialchars($find_date1)?>&amp;find_date2=<?=htmlspecialchars($find_date2)?>&amp;set_filter=Y&amp;group_by=none&amp;menu_item_id=1"><?=GetMessage("STAT_PERIOD")?></a><br> <?=$arFilter["DATE1"]?>&nbsp;- <?=$arFilter["DATE2"]?></td>
<?endif;?>
...
<?if($is_filtered):?>
	<td align="right">
		<?if(intval($ph_PERIOD_PHRASES)>0):?>
			<a href="phrase_list.php?lang=<?=LANG?>&amp;find_date1=<?echo htmlspecialchars($find_date1)?>&amp;find_date2=<?echo htmlspecialchars($find_date2)?>&amp;find_phrase=<?=urlencode("\"".htmlspecialcharsback($ph_PHRASE)."\"")?>&amp;set_filter=Y&amp;group_by=none&amp;menu_item_id=1&amp;find_phrase_exact_match=Y"><?echo $ph_PERIOD_PHRASES?></a>
		<?else:?>
			&nbsp;
		<?endif;?>
	</td>
...
<tr>
		<td align="right"><?echo GetMessage("STAT_TOTAL")?></td>
	<td align="right"><?=(intval($total_TODAY_PHRASES)>0?$total_TODAY_PHRASES:'&nbsp;')?></td>
	<td align="right"><?=(intval($total_YESTERDAY_PHRASES)>0?$total_YESTERDAY_PHRASES:'&nbsp;')?></td>
	<td align="right"><?=(intval($total_B_YESTERDAY_PHRASES)>0?$total_B_YESTERDAY_PHRASES:'&nbsp;')?></td>
<?if ($is_filtered) : ?>
	<td align="right"><?=(intval($total_PERIOD_PHRASES)>0?$total_PERIOD_PHRASES:'&nbsp;')?></td>
<?endif;?>
	<td align="right"><?=(intval($total_TOTAL_PHRASES)>0?$total_TOTAL_PHRASES:'&nbsp;')?></td>
</tr>
</table>
<?
endif;
...
<?if($is_filtered):?>
	<td><a href="hit_searcher_list.php?lang=<?=LANG?>&amp;find_date1=<?=htmlspecialchars($find_date1)?>&amp;find_date2=<?=htmlspecialchars($find_date2)?>&amp;set_filter=Y"><?=GetMessage("STAT_PERIOD")?></a><br> <?=$arFilter["DATE1"]?>&nbsp;- <?=$arFilter["DATE2"]?></td>
<?endif;?>
...
<?if($is_filtered):?>
	<td align="right">
		<?if(intval($f_PERIOD_HITS)>0):?>
			<a href="hit_searcher_list.php?lang=<?=LANG?>&amp;find_date1=<?echo htmlspecialchars($find_date1)?>&amp;find_date2=<?echo htmlspecialchars($find_date2)?>&amp;find_searcher_id=<?echo $f_ID?>&amp;find_searcher_id_exact_match=Y&amp;set_filter=Y"><?echo $f_PERIOD_HITS?></a>
		<?else:?>
			&nbsp;
		<?endif;?>
	</td>
...
<tr>
	<td align="right"><?echo GetMessage("STAT_TOTAL")?></td>
	<td align="right"><?=(intval($total_TODAY_HITS)>0?$total_TODAY_HITS:'&nbsp;')?></td>
	<td align="right"><?=(intval($total_YESTERDAY_HITS)>0?$total_YESTERDAY_HITS:'&nbsp;')?></td>
	<td align="right"><?=(intval($total_B_YESTERDAY_HITS)>0?$total_B_YESTERDAY_HITS:'&nbsp;')?></td>
<?if ($is_filtered) : ?>
	<td align="right"><?=(intval($total_PERIOD_HITS)>0?$total_PERIOD_HITS:'&nbsp;')?></td>
<?endif;?>
	<td align="right"><?=(intval($total_TOTAL_HITS)>0?$total_TOTAL_HITS:'&nbsp;')?></td>
</tr>
</table>
<?
endif;
...
<?$oFilter->Begin();?>
<tr valign="center">
	<td align="right" width="0%" nowrap><?echo GetMessage("STAT_F_PERIOD")." (".CLang::GetDateFormat("SHORT")."):"?></td>
...
<?$oFilter->Buttons()?>
<input type="submit" name="set_filter" value="<?=GetMessage("STAT_F_FIND")?>" title="<?=GetMessage("STAT_F_FIND_TITLE")?>" onClick="applyFilter(<?=$sFilterID?>, 'stat_list.php?lang=<?=LANG?>'); return false;">
<input type="submit" name="del_filter" value="<?=GetMessage("STAT_F_CLEAR")?>" title="<?=GetMessage("STAT_F_CLEAR_TITLE")?>" onClick="clearFilter(<?=$sFilterID?>, 'stat_list.php?lang=<?=LANG?>'); return false;">
<?
$oFilter->End();
?>
</form>
