...
<tr>
	...
	<td><input type="text" name="find_user_agent" size="30" value="<?echo htmlspecialchars($find_user_agent)?>"><?=ShowExactMatchCheckbox("find_user_agent")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_lang" size="30" value="<?echo htmlspecialchars($find_lang)?>"><?=ShowExactMatchCheckbox("find_lang")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_region" size="30" value="<?echo htmlspecialchars($find_region)?>"><?echo ShowExactMatchCheckbox("find_region")?>&nbsp;<?echo ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_FIRST_DATE")." (".CLang::GetDateFormat("SHORT")."):"?></td>
	<td width="0%" nowrap><?
		echo CalendarPeriod("find_first_date1", $find_first_date1, "find_first_date2", $find_first_date2, "form1","Y");
		?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_PERIOD_DATE")." (".CLang::GetDateFormat("SHORT")."):"?></td>
	<td width="0%" nowrap><?
		echo CalendarPeriod("find_period_date1", $find_period_date1, "find_period_date2",$find_period_date2, "form1","Y");
		?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_LAST_DATE")." (".CLang::GetDateFormat("SHORT")."):"?></td>
	<td width="0%" nowrap><?
...
<tr>
	...
	?>&nbsp;<?
		echo SelectBoxFromArray("find_url_404", array("reference"=>array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id"=>array("Y","N")), htmlspecialchars($find_url_404), GetMessage("STAT_404"));
	?>&nbsp;<input type="text" name="find_url" size="33" value="<?echo htmlspecialchars($find_url)?>"><?=ShowExactMatchCheckbox("find_url")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_referer1" size="10" value="<?echo htmlspecialchars($find_referer1)?>">&nbsp;/&nbsp;<input type="text" name="find_referer2" size="10" value="<?echo htmlspecialchars($find_referer2)?>"><?=ShowExactMatchCheckbox("find_referer12")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_events1" size="10" value="<?echo htmlspecialchars($find_events1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_events2" size="10" value="<?echo htmlspecialchars($find_events2)?>"></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_SESS_1_2")?>:</td>
	<td><input type="text" name="find_sess1" size="10" value="<?echo htmlspecialchars($find_sess1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_sess2" size="10" value="<?echo htmlspecialchars($find_sess2)?>"></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_HITS_1_2")?>:</td>
	<td><input type="text" name="find_hits1" size="10" value="<?echo htmlspecialchars($find_hits1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_hits2" size="10" value="<?echo htmlspecialchars($find_hits2)?>"></td>
</tr>
<?=ShowLogicRadioBtn()?>
