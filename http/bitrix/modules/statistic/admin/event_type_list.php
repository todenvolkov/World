...
function CheckFilter()
{
	...
	foreach($arr as $ar)
	{
		...
		$DB->CompareDates($ar["date1"], $ar["date2"])==1)
...
while($arRes = $rsData->NavNext(true, "f_")):
	...
	if($STAT_RIGHT=="W")
		$arActions[] = array(
			...
			"ACTION"=>"if(confirm('".GetMessage('STAT_CONFIRM_CLEAR')."')) ".$lAdmin->ActionDoGroup($f_ID, "clear")
		);
	if($STAT_RIGHT=="W")
		$arActions[] = array(
			"ICON"=>"delete",
...
<tr>
	<td>event1:</td>
	<td><input type="text" name="find_event1" size="47" value="<?echo htmlspecialchars($find_event1)?>"><?=ShowExactMatchCheckbox("find_event1")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>event2:</td>
	<td><input type="text" name="find_event2" size="47" value="<?echo htmlspecialchars($find_event2)?>"><?=ShowExactMatchCheckbox("find_event2")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_NAME")?></td>
	<td><input type="text" name="find_name" size="47" value="<?echo htmlspecialchars($find_name)?>"><?=ShowExactMatchCheckbox("find_name")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_DESCRIPTION")?></td>
	<td><input type="text" name="find_description" size="47" value="<?echo htmlspecialchars($find_description)?>"><?=ShowExactMatchCheckbox("find_description")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_counter1" size="9" value="<?echo htmlspecialchars($find_counter1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_counter2" size="9" value="<?echo htmlspecialchars($find_counter2)?>"></td>
</tr>
<?if($STAT_RIGHT>"M"):?>
<tr>
	<td><?echo GetMessage("STAT_F_MONEY")?></td>
	<td><input type="text" name="find_money1" size="9" value="<?echo htmlspecialchars($find_money1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_money2" size="9" value="<?echo htmlspecialchars($find_money2)?>"></td>
</tr>
<?if($currency_module=="Y"):?>
<tr valign="center">
...
<tr>
	...
	<td><input type="text" name="find_keep_days1" size="9" value="<?echo htmlspecialchars($find_keep_days1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_keep_days2" size="9" value="<?echo htmlspecialchars($find_keep_days2)?>"></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_F_DYNAMIC_KEEP_DAYS")?></td>
	<td><input type="text" name="find_dynamic_keep_days1" size="9" value="<?echo htmlspecialchars($find_dynamic_keep_days1)?>"><?echo "&nbsp;".GetMessage("STAT_TILL")."&nbsp;"?><input type="text" name="find_dynamic_keep_days2" size="9" value="<?echo htmlspecialchars($find_dynamic_keep_days2)?>"></td>
</tr>
<tr>
	...
	<td><?
		...
		echo SelectBoxFromArray("find_adv_visible", $arr, htmlspecialchars($find_adv_visible), GetMessage("MAIN_ALL"));
		?></td>
</tr>
<tr>
	...
	<td class="tablebody" width="0%" nowrap><?
		$arr = array("reference"=>array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id"=>array("Y","N"));
		echo SelectBoxFromArray("find_diagram_default", $arr, htmlspecialchars($find_diagram_default), GetMessage("MAIN_ALL"));
		?></td>
</tr>
<?
