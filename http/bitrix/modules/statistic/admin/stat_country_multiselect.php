...
<tr>
	...
	<td><input type="text" name="find_id" size="47" value="<?echo htmlspecialchars($find_short_name)?>"><?=ShowExactMatchCheckbox("find_short_name")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("STAT_COUNTRY_MSEL_NAME")?></td>
	<td><input type="text" name="find_id" size="47" value="<?echo htmlspecialchars($find_name)?>"><?=ShowExactMatchCheckbox("find_name")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<?
