...
<tr>
	...
	<td><input type="text" name="find_phrase" size="47" value="<?echo htmlspecialchars($find_phrase)?>"><?=ShowExactMatchCheckbox("find_phrase")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr valign=top>
	...
	<td><?
		...
		echo SelectBox("find_searcher_id",$z,GetMessage("MAIN_ALL"), htmlspecialchars($find_searcher_id));
		?><br><table cellspacing="0" cellpadding="0" width="0%">
			<tr>
				<td>ID:</td>
				<td><?=GetMessage("STAT_NAME")?>:</td>
			</tr>
			<tr>
				<td><input type="text" name="find_searcher_id_str" size="20" value="<?echo htmlspecialchars($find_searcher_id_str)?>">&nbsp;</td>
				<td><input type="text" name="find_searcher" size="40" value="<?echo htmlspecialchars($find_searcher)?>"><?=ShowExactMatchCheckbox("find_searcher")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
			</tr>
		</table></td>
</tr>
<tr>
...
<tr>
	...
	?>&nbsp;<input type="text" name="find_to" size="33" value="<?echo htmlspecialchars($find_to)?>"><?=ShowExactMatchCheckbox("find_to")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td nowrap><?echo GetMessage("STAT_F_REFERER")?></td>
	<td><input type="text" name="find_referer_id" size="47" value="<?echo htmlspecialchars($find_referer_id)?>"><?=ShowExactMatchCheckbox("find_referer_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
