...
<tr>
	<td>ID:</td>
	<td><input type="text" name="find_id" size="35" value="<?echo htmlspecialchars($find_id)?>"><?=ShowExactMatchCheckbox("find_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td>referer1:</td>
...
<tr>
	...
	<td><input type="text" name="find_description" size="35" value="<?echo htmlspecialchars($find_description)?>"><?=ShowExactMatchCheckbox("find_description")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
