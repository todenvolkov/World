...
$lAdmin_tab1->InitFilter($arFilterFields);
...
elseif(is_array($ar))
	...
	$title = "[".$find."]";
$lAdmin_tab1->onLoadScript = "jsUtils.SetPageTitle('".AddSlashes(GetMessage("STAT_ADV_CAMPAIGN_TITLE")." ".$title)."');";
...
$lAdmin_tab2->InitFilter($arFilterFields);
