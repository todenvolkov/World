		...
		<tr>
			<td>
				<table cellpadding="3" cellspacing="0" border="0">
					<tr>
						<td valign="center" nowrap><img src="/bitrix/admin/city_graph.php?find_data_type=<?=$find_data_type?><?=GetFilterParams($FilterArr)?>&width=<?=$width?>&height=<?=$height?>&lang=<?echo LANG?>" width="<?=$width?>" height="<?=$height?>"></td>
					</tr>
				</table>
			</td>
		</tr>
...
<table cellspacing=0 cellpadding=10 class="graph">
	<tr>
		<td valign="top"><img src="/bitrix/admin/city_diagram.php?<?=GetFilterParams($FilterArr)?>&lang=<?=LANG?>&find_data_type=<?=$find_data_type?>" width="<?=$diameter?>" height="<?=$diameter?>"></td>
		<td valign="top">
			<table cellpadding=2 cellspacing=0 border=0 class="legend">
				...
				<tr>
					...
					?>)</td>
					<td nowrap><?=htmlspecialchars($name)?></td>
				</tr>
				<?endforeach;?>
			</table>
		</td>
...
<table cellspacing=0 cellpadding=10 class="graph">
	<tr>
		<td valign="top"><img src="/bitrix/admin/city_diagram.php?<?=GetFilterParams($FilterArr)?>&lang=<?=LANGUAGE_ID?>&find_data_type=<?=$find_data_type?>&diagram_type=TOTAL" width="<?=$diameter?>" height="<?=$diameter?>"></td>
		<td valign="top">
			<table cellpadding=2 cellspacing=0 border=0 class="legend">
				<?
				$sum = 0;
