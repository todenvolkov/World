...
<table border="0" cellspacing="1" cellpadding="1" class="list">
	...
	<tr>
		...
		<td valign="top">&nbsp;<?echo urldecode($f_LAST_LANGUAGE)?></td>
	</tr>
	<?if($USER->IsAdmin()):?>
	<tr>
		<td valign="top" nowrap>
...
<?echo EndNote();?>
<form><input type="button" onClick="window.close()" value="<?echo GetMessage("STAT_CLOSE")?>"></form></div>
