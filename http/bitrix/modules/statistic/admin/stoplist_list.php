...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if ($row->bEditMode)
	{
		...
		for ($i = 1; $i <=4; $i++)
		{
			...
			$str .= '
			<input type="text" maxlength="3" size="3" name="FIELDS['.htmlspecialchars($f_ID).'][IP_'.$i.']" value="'.htmlspecialchars($val).'">
			<input type="hidden" name="FIELDS_OLD['.htmlspecialchars($f_ID).'][IP_'.$i.']" value="'.htmlspecialchars(${"f_IP_".$i}).'">';

			$str2 .= '
			<input type="text" maxlength="3" size="3" name="FIELDS['.htmlspecialchars($f_ID).'][MASK_'.$i.']" value="'.htmlspecialchars($val2).'">
			<input type="hidden" name="FIELDS_OLD['.htmlspecialchars($f_ID).'][MASK_'.$i.']" value="'.htmlspecialchars(${"f_MASK_".$i}).'">';
		}
	...
	if ($STAT_RIGHT>="W")
	{
		...
		$arActions[] = array(
			...
			"ACTION"=>"if(confirm('".GetMessage('STAT_CONFIRM_DEL_STOP')."')) ".$lAdmin->ActionDoGroup($f_ID, "delete"));
	}
...
<tr valign="center">
	<td width="0%" nowrap>
		<?echo GetMessage("STAT_F_DATE_START")." (".CLang::GetDateFormat("SHORT")."):"?></td>
	<td width="0%" nowrap>
		<?echo CalendarPeriod("find_date_start_1", htmlspecialchars($find_date_start_1), "find_date_start_2", htmlspecialchars($find_date_start_2), "form1","Y")?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap>
		<?echo GetMessage("STAT_F_DATE_END")." (".CLang::GetDateFormat("SHORT")."):"?></td>
	<td width="0%" nowrap>
		<?echo CalendarPeriod("find_date_end_1", htmlspecialchars($find_date_end_1), "find_date_end_2", htmlspecialchars($find_date_end_2), "form1","Y")?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap>
...
<tr valign="center">
	...
	<td width="0%" nowrap>
		<?
		$arr = array("reference"=>array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id"=>array("Y","N"));
		echo SelectBoxFromArray("find_save_statistic", $arr, htmlspecialchars($find_save_statistic), GetMessage("MAIN_ALL"));
		?></td>
</tr>
</tr>
<tr valign="center">
	...
	<td width="0%" nowrap>
		<input type="text" name="find_ip_1" value="<?echo htmlspecialchars($find_ip_1)?>" size="6" >
		<input type="text" name="find_ip_2" value="<?echo htmlspecialchars($find_ip_2)?>" size="6" >
		<input type="text" name="find_ip_3" value="<?echo htmlspecialchars($find_ip_3)?>" size="6" >
		<input type="text" name="find_ip_4" value="<?echo htmlspecialchars($find_ip_4)?>" size="7" ><?=ShowExactMatchCheckbox("find_ip")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_USER_AGENT")?>:</td>
	<td width="0%" nowrap><input type="text" name="find_user_agent" value="<?echo htmlspecialchars($find_user_agent)?>" size="47"><?=ShowExactMatchCheckbox("find_user_agent")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_FROM")?>:</td>
	<td width="0%" nowrap><input type="text" name="find_url_from" value="<?echo htmlspecialchars($find_url_from)?>" size="47"><?=ShowExactMatchCheckbox("find_url_from")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_TO")?>:</td>
	<td width="0%" nowrap><input type="text" name="find_url_to" value="<?echo htmlspecialchars($find_url_to)?>" size="47"><?=ShowExactMatchCheckbox("find_url_to")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_REDIRECT")?>:</td>
	<td width="0%" nowrap><input type="text" name="find_url_redirect" value="<?echo htmlspecialchars($find_url_redirect)?>" size="47"><?=ShowExactMatchCheckbox("find_url_redirect")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_MESSAGE")?>:</td>
	<td width="0%" nowrap><input type="text" name="find_message" value="<?echo htmlspecialchars($find_message)?>" size="47"><?=ShowExactMatchCheckbox("find_message")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td width="0%" nowrap><?echo GetMessage("STAT_F_COMMENTS")?>:</td>
	<td width="0%" nowrap><input type="text" name="find_comments" value="<?echo htmlspecialchars($find_comments)?>" size="47"><?=ShowExactMatchCheckbox("find_comments")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<?=ShowLogicRadioBtn()?>
