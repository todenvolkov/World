...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if ($bSimple)
		$arActions[] = array(
			...
			"ACTION"=>$lAdmin->ActionRedirect("form_field_edit_simple.php?lang=".LANGUAGE_ID."&ID=$f_ID&WEB_FORM_ID=$WEB_FORM_ID&additional=$additional&from_edit=$from_edit"),
		...
		$arActions[] = array(
			...
			"ICON"=>"edit",
			"TITLE"=>GetMessage("FORM_EDIT_ALT"),
			"ACTION"=>$lAdmin->ActionRedirect("form_field_edit.php?lang=".LANGUAGE_ID."&ID=$f_ID&WEB_FORM_ID=$WEB_FORM_ID&additional=$additional&from_edit=$from_edit"),
			"TEXT"=>GetMessage("FORM_FIELD_EDIT")
		);
	...
	if ($F_RIGHT>=30)
	{
		$arActions[] = array(
			...
			"ACTION"=>$lAdmin->ActionRedirect("form_field_list.php?copy_id=$f_ID&lang=".LANGUAGE_ID."&WEB_FORM_ID=$WEB_FORM_ID&additional=$additional&from_edit=$from_edit&".bitrix_sessid_get()),
			"TEXT"=>GetMessage("FORM_CP")
		);
		$arActions[] = array(
			"ICON"=>"delete",
			"TITLE"=>GetMessage("FORM_DELETE_FIELD"),
			"ACTION"=>$lAdmin->ActionRedirect("javascript:if(confirm('".GetMessage("FORM_CONFIRM_DELETE")."')) window.location='?lang=".LANGUAGE_ID."&action=delete&ID=$f_ID&WEB_FORM_ID=$WEB_FORM_ID&additional=$additional&from_edit=$from_edit&".bitrix_sessid_get()."'"),
