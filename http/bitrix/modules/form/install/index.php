...
Class form extends CModule
{
	...
	function InstallFiles()
	{
		...
		// create dir for temporary template files
		if (!file_exists($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/tmp/form"))
		{
			@mkdir($_SERVER['DOCUMENT_ROOT'].BX_PERSONAL_ROOT."/tmp/form/", BX_DIR_PERMISSIONS);
		}
