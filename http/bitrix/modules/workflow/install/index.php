...
Class workflow extends CModule
{
	...
	function InstallFiles($arParams = array())
	{
		...
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/workflow/install/themes/", $_SERVER["DOCUMENT_ROOT"]."/bitrix/themes", true, true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/workflow/install/components", $_SERVER["DOCUMENT_ROOT"]."/bitrix/components", True, True);
	...
	function UnInstallFiles()
	{
		...
		//css
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/workflow/install/themes/.default/", $_SERVER["DOCUMENT_ROOT"]."/bitrix/themes/.default");
		//icons
		DeleteDirFilesEx("/bitrix/themes/.default/icons/workflow/");
		//images
