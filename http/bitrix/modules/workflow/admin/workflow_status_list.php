...
<tr valign="center">
	...
	<td nowrap><input type="text" name="find_title" value="<?echo htmlspecialchars($find_title)?>" size="47"><?=ShowExactMatchCheckbox("find_title")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td nowrap><?=GetMessage("FLOW_F_DESCRIPTION")?>:</td>
	<td nowrap><input type="text" name="find_description" value="<?echo htmlspecialchars($find_description)?>" size="47"><?=ShowExactMatchCheckbox("find_description")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr valign="center">
	<td nowrap><?echo GetMessage("FLOW_F_DOCUMENTS")?>:</td>
	<td nowrap><input type="text" name="find_documents_1" value="<?=htmlspecialchars($find_documents_1)?>" size="5"><?echo "&nbsp;".GetMessage("FLOW_TILL")."&nbsp;"?><input type="text" name="find_documents_2" value="<?=htmlspecialchars($find_documents_2)?>" size="5"></td>
</tr>
<?=ShowLogicRadioBtn()?>
