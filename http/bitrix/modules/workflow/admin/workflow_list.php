	...
	<td><?
		$arr = array(
			...
			"reference_id"=>array(
				...
				"yellow",
				"green"));
		echo SelectBoxFromArray("find_lock_status", $arr, htmlspecialchars($find_lock_status), GetMessage("MAIN_ALL"));
	?></td>
</tr>
<tr>
	<td><?echo GetMessage("FLOW_F_DATE_MODIFY")." (".CLang::GetDateFormat("SHORT")."):"?></td>
...
<tr>
	...
	<td><input type="text" name="find_modified_user_id" value="<?echo htmlspecialchars($find_modified_user_id)?>" size="47"><?=ShowExactMatchCheckbox("find_modified_user_id")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_filename" value="<?echo htmlspecialchars($find_filename)?>" size="47"><?=ShowExactMatchCheckbox("find_filename")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?=GetMessage("FLOW_F_TITLE")?>:</td>
	<td><input type="text" name="find_title" value="<?echo htmlspecialchars($find_title)?>" size="47"><?=ShowExactMatchCheckbox("find_title")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?=GetMessage("FLOW_F_BODY")?>:</td>
	<td><input type="text" name="find_body" value="<?echo htmlspecialchars($find_body)?>" size="47"><?=ShowExactMatchCheckbox("find_body")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?=GetMessage("FLOW_F_STATUS")?>:</td>
	<td><input type="text" name="find_status" value="<?echo htmlspecialchars($find_status)?>" size="47"><?=ShowExactMatchCheckbox("find_status")?>&nbsp;<?=ShowFilterLogicHelp()?><br><?
	echo SelectBox("find_status_id", CWorkflowStatus::GetDropDownList(), GetMessage("MAIN_ALL"), htmlspecialchars($find_status_id));
	?></td>
</tr>
<?=ShowLogicRadioBtn()?>
