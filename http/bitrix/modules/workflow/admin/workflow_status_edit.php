...
$aTabs = array(
	array("DIV" => "edit1", "TAB" => GetMessage("FLOW_EDIT_RECORD"), "ICON"=>"workflow_edit", "TITLE"=>GetMessage("FLOW_EDIT_RECORD")." ".$str_TITLE),
);
...
<?endif;?>
	...
	<tr>
		<td><span class="required">*</span>&nbsp;<?=GetMessage("FLOW_TITLE")?></td>
		<td><input type="text" name="TITLE" maxlength="255" value="<?=$str_TITLE?>" style="width:60%"></td>
	</tr>
	<tr>
		<td valign="top"><?=GetMessage("FLOW_DESCRIPTION")?></td>
		<td><textarea name="DESCRIPTION" rows="5" style="width:60%"><?echo $str_DESCRIPTION?></textarea></td>
	</tr>
	<tr valign="top">
		<td valign="top"><?=GetMessage('FLOW_MOVE_RIGHTS');?><br><img src="/bitrix/images/workflow/mouse.gif" width="44" height="21" border=0 alt=""></td>
		<td><?echo SelectBoxM("arPERMISSION_M[]", CGroup::GetDropDownList(""), $arPERMISSION_M,"",true,8);?></td>
	</tr>
	<tr valign="top">
		<td valign="top"><?if ($ID!=1) echo GetMessage('FLOW_EDIT_RIGHTS'); else echo GetMessage("FLOW_VIEW")?><br><img src="/bitrix/images/workflow/mouse.gif" width="44" height="21" border=0 alt=""></td>
