...
<?if($arParams["USE_RSS"]=="Y"):?>
	...
	?>
	<a href="<?=$rss_url?>" title="rss" target="_self"><img alt="RSS" src="<?=$templateFolder?>/images/gif-light/feed-icon-16x16.gif" border="0" align="right" style="margin-top: 5px; margin-right: 2px;" /></a>
<?endif?>
