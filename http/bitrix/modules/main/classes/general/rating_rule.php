...
class CRatingRule
{
	...
	function Add($arFields)
	{
		...
		$arFields_i = Array(
			...
			"ACTION_NAME"			=> $arFields["ACTION_NAME"],
			...
			"ACTIVATE_CLASS"		=> $arRatingRuleConfigs['ACTION_CONFIG'][$arFields["ACTION_NAME"]]['CLASS'],
			"ACTIVATE_METHOD"		=> $arRatingRuleConfigs['ACTION_CONFIG'][$arFields["ACTION_NAME"]]['METHOD'],
			"DEACTIVATE_CLASS"		=> $arRatingRuleConfigs['ACTION_CONFIG'][$arFields["ACTION_NAME"]]['CLASS'],
			"DEACTIVATE_METHOD"		=> $arRatingRuleConfigs['ACTION_CONFIG'][$arFields["ACTION_NAME"]]['METHOD'],
		...
		$arFields_u = Array(
			"CONDITION_CONFIG" => "'".serialize($arFields["CONDITION_CONFIG"])."'",
			"ACTION_CONFIG" => "'".serialize($arFields["ACTION_CONFIG"])."'",
		);
	...
	function Update($ID, $arFields)
	{
		...
		if (!isset($arFields["CONDITION_CONFIG"]) || !isset($arFields["ACTION_CONFIG"]))
			return true;
