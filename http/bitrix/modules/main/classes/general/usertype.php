					...
					switch($FIELD_TYPE)
					{
						...
						case "string":
							...
							switch($operation)
							{
								...
								case "M":
									if(is_array($FIELD_VALUE))
										$result[] = "(".$FIELD_NAME." like '".implode("' OR ".$this->_Upper($FIELD_NAME)." like '", $FIELD_VALUE)."')";
									elseif(strlen($FIELD_VALUE)<=0)
										$result[] = "(".$FIELD_NAME." IS NULL OR ".$length_func."(".$FIELD_NAME.") = 0)";
									else
									{
								...
								case "NM":
									if(is_array($FIELD_VALUE))
										$result[] = "(".$FIELD_NAME." not like '".implode("' AND ".$this->_Upper($FIELD_NAME)." not like '", $FIELD_VALUE)."')";
									elseif(strlen($FIELD_VALUE)<=0)
										$result[] = "(".$FIELD_NAME." IS NOT NULL AND ".$length_func."(".$FIELD_NAME.") > 0)";
									else
