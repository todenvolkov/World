...
$aHeaders = array(
	...
	array("id"=>"CREATED", "content"=>GetMessage("RATING_RULE_CREATED"), "sort"=>"created", "default"=>true),
	...
	array("id"=>"ENTITY_TYPE_ID", "content"=>GetMessage("RATING_RULE_ENTITY_TYPE_ID"), "sort"=>"entity_type_id", "default"=>true),
);
...
<?$oFilter->Begin();?>
	...
	<tr>
		...
		<td><input type="text" name="find_entity_type_id" value="<?echo htmlspecialchars($find_entity_type_id)?>" size="40"><?=ShowFilterLogicHelp()?></td>
	</tr>
<?
