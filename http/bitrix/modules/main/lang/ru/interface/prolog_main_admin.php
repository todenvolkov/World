...
$MESS ['prolog_main_support1'] = "<span class=\"required\">Внимание!</span> Срок активности техподдержки и обновлений <b>заканчивается</b> #FINISH_DATE#, #DAYS_AGO#. В течение одного месяца после завершения техподдержки вы можете приобрести <a href=\"http://www.1c-bitrix.ru/buy/cms.php#tab-update-link\">льготное продление</a>.";
$MESS ['prolog_main_support_days'] = "через <b>#N_DAYS_AGO#&nbsp;дней</b>";
$MESS ['prolog_main_support2'] = "<span class=\"required\">Внимание!</span> Срок активности техподдержки и обновлений <b>закончился</b> #FINISH_DATE#, <b>#DAYS_AGO#&nbsp;дней</b> назад. В течение одного месяца после завершения техподдержки вы можете приобрести <a href=\"http://www.1c-bitrix.ru/buy/cms.php#tab-update-link\">льготное продление</a>.";
$MESS ['prolog_main_support3'] = "<span class=\"required\">Внимание!</span> Срок активности техподдержки и обновлений <b>закончился</b> #FINISH_DATE#. Вы можете приобрести <a href=\"http://www.1c-bitrix.ru/buy/cms.php#tab-update-link\">стандартное продление</a> техподдержки.";
...
$MESS ['TRIAL_ATTENTION_TEXT5_1c_bitrix_gosportal'] = "Вы можете купить полнофункциональную версию продукта по адресу <a href=\"http://www.1c-bitrix.ru/buy/?r1=bsm7trial&amp;r2=expiried\">http://www.1c-bitrix.ru/buy/</a>";
