...
$arAllOptions = array(
	...
	"auth" => Array(
		...
		GetMessage("MAIN_OPTION_SESS"),
		Array("session_expand", GetMessage("MAIN_OPTION_SESS_EXPAND"), "Y", Array("checkbox", "Y")),
		Array("session_show_message", GetMessage("MAIN_OPTION_SESS_MESS"), "Y", Array("checkbox", "Y")),
	),
	"event_log" => Array(
