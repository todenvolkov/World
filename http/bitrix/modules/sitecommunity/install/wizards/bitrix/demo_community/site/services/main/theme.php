...
/************** Forum Theme ****************************************/
$forum_theme = WIZARD_THEME_ID;
if (WIZARD_TEMPLATE_ID == "taby")
{
	if (WIZARD_THEME_ID == "orange")
		$forum_theme = "white";
	elseif (WIZARD_THEME_ID == "red" || WIZARD_THEME_ID == "green")
		$forum_theme = "gray";
}
elseif (WIZARD_TEMPLATE_ID == "wide" && WIZARD_THEME_ID == "blue")
{
	$forum_theme = "white";
}
COption::SetOptionString("main", "wizard_".WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID."_forum_theme_id", $forum_theme, "", WIZARD_SITE_ID); 
/************** Forum Theme****************************************/
?>