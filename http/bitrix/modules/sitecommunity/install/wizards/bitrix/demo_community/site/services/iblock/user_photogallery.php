...
$iblockCode = "user_photogallery_community_".WIZARD_SITE_ID; 
$iblockType = "photos"; 
$iblockID = false; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/photo/index.php", array("IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/people/user.php", array("PHOTO_USER_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_inc.php", array("PHOTO_USER_IBLOCK_ID" => $iblockID));
?>
