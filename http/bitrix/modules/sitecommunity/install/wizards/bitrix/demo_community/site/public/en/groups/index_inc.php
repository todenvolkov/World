...
<div class="filter-box filter-people">
	<form method="get" action="#SITE_DIR#groups/" class="bx-selector-form filter-form">
		...
		<div class="filter-item filter-name">
			...
			<input type="text" id="filter-name" name="q" class="filter-textbox" value="<?= htmlspecialchars(trim($_REQUEST["q"])) ?>"/>
		</div>
		...
		<div class="filter-button">
			<input type="submit" name="set_filter" value="Search" class="filter-submit" />
			<input type="reset" name="del_filter" value="Cancel" class="filter-submit filter-inline" onclick="window.location='#SITE_DIR#groups/'" />
		</div>
	</form>
</div>
	</div>
