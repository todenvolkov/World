...
<div class="rounded-block">
	...
	<div class="block-content">
		<h3>New Posts</h3>
<?$APPLICATION->IncludeComponent("bitrix:forum.topic.last", "sidebar", array(
	"FID" => #FORUM_ID#,
	"SORT_BY" => "LAST_POST_DATE",
	"SORT_ORDER" => "DESC",
	"SORT_BY_SORT_FIRST" => "N",
	"URL_TEMPLATES_INDEX" => "#SITE_DIR#forum/",
	"URL_TEMPLATES_LIST" => "#SITE_DIR#forum/forum#FID#/",
	"URL_TEMPLATES_READ" => "#SITE_DIR#forum/forum#FID#/topic#TID#/",
	"URL_TEMPLATES_MESSAGE" => "#SITE_DIR#forum/messages/forum#FID#/topic#TID#/message#MID#/",
	"URL_TEMPLATES_PROFILE_VIEW" => "#SITE_DIR#people/user/#UID#/",
	"CACHE_TYPE" => "A",
	"CACHE_TIME" => "36000000",
	"TOPICS_PER_PAGE" => "10",
