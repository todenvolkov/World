...
<?else:
	...
	if(strlen($strError)>0)
	{
		...
		<tr>
			...
			<td width="60%"><input type="text" id="security_SECRET" name="security_SECRET" size="50" maxlength="50" value="<?=$str_security_SECRET?>" <?echo ($str_security_ACTIVE==="Y"? "": "disabled")?>></td>
		</tr>
		<tr class="heading">
