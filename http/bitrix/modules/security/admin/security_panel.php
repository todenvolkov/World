...
$rsLog = CEventLog::GetList(array(), array(
	"TIMESTAMP_X_1" => ConvertTimeStamp(time()-$days*24*3600, "FULL"),
	"AUDIT_TYPE_ID" => "SECURITY_FILTER_SQL|SECURITY_FILTER_XSS|SECURITY_FILTER_PHP|SECURITY_REDIRECT",
));
while($rsLog->Fetch())
	$cntLog++;
...
$data['std']['ITEMS'][] = array(
	...
	"KPI_RECOMMENDATION" => (
		...
		(
			...
			'<a href="event_log.php?lang='.LANGUAGE_ID.'&amp;set_filter=Y&amp;find_type=audit_type_id&amp;find_audit_type[]=SECURITY_FILTER_SQL&amp;find_audit_type[]=SECURITY_FILTER_XSS&amp;find_audit_type[]=SECURITY_FILTER_PHP&amp;find_audit_type[]=SECURITY_REDIRECT&amp;mod=security">'.GetMessage("SEC_PANEL_FILTER_LOG_RECOMMENDATION").'</a>'
