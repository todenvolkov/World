...
if($USER->CanDoOperation('view_event_log'))
{
	$aMenu["items"][] = array(
		...
		"url" => "/bitrix/admin/event_log.php?lang=".LANGUAGE_ID."&set_filter=Y&find_type=audit_type_id&find_audit_type[]=SECURITY_VIRUS&find_audit_type[]=SECURITY_FILTER_SQL&find_audit_type[]=SECURITY_FILTER_XSS&find_audit_type[]=SECURITY_FILTER_PHP&find_audit_type[]=SECURITY_REDIRECT&mod=security",
...
/*	$aMenu["items"][] = array(
		"text" => GetMessage("SEC_MENU_PHP_ITEM"),
		"url" => "security_php.php?lang=".LANGUAGE_ID,
		"more_url" => Array("security_php.php"),
		"title" => GetMessage("SEC_MENU_PHP_TITLE"),
	);*/
