...
$MESS ['SEC_REDIRECT_REFERER_CHECK'] = "Check for presence of HTTP header describing the reffering page.";
$MESS ['SEC_REDIRECT_REFERER_SITE_CHECK'] = "The \"Referrer\" HTTP header must contain the current site's domain name. ";
$MESS ['SEC_REDIRECT_HREF_SIGN'] = "Add digital signuture to the below URLs:";
...
$MESS ['SEC_REDIRECT_ACTION_SHOW_MESSAGE'] = "Show notification message and redirect to another site after delay.";
$MESS ['SEC_REDIRECT_MESSAGE'] = "Message:";
$MESS ['SEC_REDIRECT_TIMEOUT'] = "Delay:";
$MESS ['SEC_REDIRECT_TIMEOUT_SEC'] = "sec.";
$MESS ['SEC_REDIRECT_LOG'] = "Add phishing attempt to the <a href=\"#HREF#\">log</a>";
