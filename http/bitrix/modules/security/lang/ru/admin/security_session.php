...
$MESS ['SEC_SESSION_ADMIN_SESSID_NOTE'] = "<p>При включении смены идентификатор сессии пользователя начнет изменятся через заданный промежуток времени. Это создает дополнительную нагрузку на сервер, но позволяет сделать похищение авторизованной сессии неэффективным.</p>
<p><i>Рекомендуется включить для высокого уровня.</i></p>";
