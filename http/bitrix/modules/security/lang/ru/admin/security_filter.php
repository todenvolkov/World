...
$MESS ['SEC_FILTER_NOTE'] = "<p><b>Проактивный фильтр (Web Application Firewall*)</b> обеспечивает защиту от большинства известных атак на веб-приложения. В потоке внешних запросов пользователей проактивный фильтр распознает большинство опасных угроз и блокирует вторжения на сайт.</p>
<p>Проактивный фильтр (Web Application Firewall) – наиболее эффективный способ защиты от возможных ошибок безопасности, допущенных при реализации интернет-проекта (XSS, SQL Injection, PHP Including и ряда других).</p>
...
<p><b>*WAF (Web Application Firewall)</b> - это специализированные средства проактивной защиты веб-приложений, которые выполняют фильтрацию трафика.</p>
