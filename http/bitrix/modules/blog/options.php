...
$arAllOptions = array(
	array("avatar_max_size", GetMessage("BLO_AVATAR_MAX_SIZE"), "30000", Array("text", 10)),
	array("avatar_max_width", GetMessage("BLO_AVATAR_MAX_WIDTH"), "100", Array("text", 10)),
	array("avatar_max_height", GetMessage("BLO_AVATAR_MAX_HEIGHT"), "100", Array("text", 10)),
