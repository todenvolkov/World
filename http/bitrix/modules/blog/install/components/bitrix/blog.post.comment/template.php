				...
				<table class="blog-comment-form-noborder" cellspacing="0">
					<tr valign="top">
						...
						<table class="blog-comment-form-noborder-padding" cellspacing="0">
							<tr valign="middle">
								<td style="background-image:url(<?=$templateFolder?>/images/toolbarbg.gif)"><select name="ffont" id="select_font" onchange="alterfont(this.options[this.selectedIndex].value, 'FONT')">
								...
								<td nowrap style="background-image:url(<?=$templateFolder?>/images/toolbarbg.gif)">
								...
								<td width=100% align=right nowrap style="background-image:url(<?=$templateFolder?>/images/toolbarbg.gif)"><a id=close_all style=visibility:hidden class=blogButton href='javascript:closeall()' title='<?=GetMessage("BPC_CLOSE_OPENED_TAGS")?>'><?=GetMessage("BPC_CLOSE_ALL_TAGS")?></a></td>
							</tr>
					</table>
						</td>
					</tr>
					...
					?>
					<tr valign="top">
						<td align="right" width="0%"><?=GetMessage("B_B_MS_M_BODY")?><span class="blog-req">*</span></td>
						<td width="100%"><textarea name="comment" id="comment" style="width:95%" rows="5" id="MESSAGE" onKeyPress="check_ctrl_enter(arguments[0])"></textarea>
						</td>
					</tr>
					<?
				...
				<tr>
					...
					<tr>
						...
						if(strlen($comment["urlToBlog"])>0)
						{
							...
							<td align="right" nowrap><a href="<?=$comment["urlToBlog"]?>"><?=$comment["AuthorName"]?></a></td>
							<?
						}
