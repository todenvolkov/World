...
$arForums = Array(
	Array(
		...
		"PATH2FORUM_MESSAGE" => "",
		"ALLOW_UPLOAD_EXT" => "",
		"FORUM_GROUP_ID" => $arGroupID["INFOPORTAL"],
		"ASK_GUEST_EMAIL" => "N",
		"USE_CAPTCHA" => "N",
		"SITES" => Array(
	...
	Array(
		"XML_ID" => "INFOPORTAL_PHOTO_COMMENTS",
	...
	Array(
		"XML_ID" => "INFOPORTAL_NEWS_COMMENTS",
...
$iForumIDForum = 0; 
$dbRes = CForumNew::GetListEx(array(), array("SITE_ID" => WIZARD_SITE_ID, "XML_ID" => "INFOPORTAL_NEWS_COMMENTS"));
if ($arRes = $dbRes->Fetch())
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/news/index.php", Array("FORUM_ID" => $iForumIDForum, "USE_REVIEW" => "Y"));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/nationalnews/index.php", Array("FORUM_ID" => $iForumIDForum, "USE_REVIEW" => "Y"));
