...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/resume.xml"; 
...
$codeRequired = '3 => "' . $arProperty['FIO'] . '", 4 => "' . $arProperty['SEX'] . '",  5 => "' . $arProperty['AGE'] . '",  5 => "' . $arProperty['EMAIL'] . '", '; 
