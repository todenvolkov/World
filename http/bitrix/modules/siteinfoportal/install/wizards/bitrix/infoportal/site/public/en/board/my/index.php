...
?><?$APPLICATION->IncludeComponent("bitrix:iblock.element.add", ".default", array(
	"NAV_ON_PAGE" => "10",
	"USE_CAPTCHA" => "Y",
	"USER_MESSAGE_ADD" => "You Ad has been added",
	"USER_MESSAGE_EDIT" => "You Ad has been saved",
	...
	"CUSTOM_TITLE_DETAIL_TEXT" => "Ad text",
	"CUSTOM_TITLE_DETAIL_PICTURE" => "",
	"SEND_EMAIL" => "Y",
	"EMAIL_TO" => "#EMAIL_TO#",
	"SUBJECT" => "A new announcement has been submitted",
