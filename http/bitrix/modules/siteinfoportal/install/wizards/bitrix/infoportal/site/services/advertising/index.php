...
$rsADV = CAdvContract::GetList($v1="s_sort", $v2="desc", array("NAME" => 'Default', 'DESCRIPTION' => GetMessage("CONTRACT_DESC")." [".WIZARD_SITE_ID."]"));
...
if ($contractId == false){
	...
	$pathToBanner = $pathToBanner."/lang/".LANGUAGE_ID;
