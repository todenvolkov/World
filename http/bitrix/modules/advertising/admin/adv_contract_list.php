...
while($arRes = $rsData->NavNext(true, "f_")):
	...
	if (is_array($arrSITE)):
		foreach($arrSITE as $sid):
			if ($isAdmin)
				$sites .= '<a href="/bitrix/admin/site_edit.php?LID='.htmlspecialchars($sid).'&amp;lang='.LANGUAGE_ID.'" title="'.GetMessage("ADV_SITE_VIEW").'">'.htmlspecialchars($arrSites[$sid]["NAME"]).'</a><br>';
			else
				$sites .= htmlspecialchars($arrSites[$sid]["NAME"])."<br>";
		endforeach;
	endif;
...
<tr>
	<td nowrap><?echo GetMessage("AD_F_DATE_MODIFY")." (".CSite::GetDateFormat("SHORT")."):"?></td>
	<td nowrap><?echo CalendarPeriod("find_date_modify_1", htmlspecialchars($find_date_modify_1), "find_date_modify_2", htmlspecialchars($find_date_modify_2), "form1","Y")?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_banner_count_1" size="10" value="<?=htmlspecialchars($find_banner_count_1)?>"><?echo "&nbsp;".GetMessage("AD_TILL")."&nbsp;"?><input type="text" name="find_banner_count_2" size="10" value="<?=htmlspecialchars($find_banner_count_2)?>"></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_owner" size="47" value="<?echo htmlspecialchars($find_owner)?>"><?=InputType("checkbox", "find_owner_exact_match", "Y", $find_owner_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_description" size="47" value="<?echo htmlspecialchars($find_description)?>"><?=InputType("checkbox", "find_description_exact_match", "Y", $find_description_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<?if ($isAdmin || $isDemo):?>
<tr>
	<td><?echo GetMessage("AD_F_ADMIN_COMMENTS")?>:</td>
	<td><input type="text" name="find_admin_comments" size="47" value="<?echo htmlspecialchars($find_admin_comments)?>"><?=InputType("checkbox", "find_admin_comments_exact_match", "Y", $find_owner_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<?endif;?>
<?
