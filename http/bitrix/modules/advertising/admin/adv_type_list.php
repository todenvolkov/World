...
<tr>
	...
	<td><input type="text" name="find_sid" size="47" value="<?echo htmlspecialchars($find_sid)?>"><?=InputType("checkbox", "find_sid_exact_match", "Y", $find_sid_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><?
		...
		echo SelectBoxFromArray("find_active", $arr, htmlspecialchars($find_active), GetMessage('AD_ALL'));
		?></td>
</tr>
<tr>
