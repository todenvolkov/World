...
{
	$type_id[$arType["SID"]] = htmlspecialchars($arType["NAME"]);
}
...
while($arRes = $rsData->NavNext(true, "f_")):
	...
	if (is_array($arrSITE)):
		foreach($arrSITE as $sid):
			...
			{
				if ($isAdmin)
					$sites .= htmlspecialchars($arrSites[$sid]["NAME"]).' [<a href="/bitrix/admin/site_edit.php?LID='.htmlspecialchars($sid).'&amp;lang='.LANGUAGE_ID.'" title="'.GetMessage("ADV_SITE_VIEW").'">'.htmlspecialchars($sid).'</a>]<br>';
				else
					$sites .= htmlspecialchars($arrSites[$sid]["NAME"])." [".htmlspecialchars($sid)."]<br>";
			}
		endforeach;
	endif;
...
while ($arContract = $rsContract->Fetch())
{
	...
	$aContext[0]["MENU"][] = Array(
								"TEXT" 		=> "[".$arContract["ID"]."] ".htmlspecialchars($arContract["NAME"]),
...
<tr>
	...
	<td nowrap>
		<input type="text" size="25" name="find" value="<?echo htmlspecialchars($find)?>" title="<?=GetMessage("ADV_FLT_SEARCH_TITLE")?>">
...
<tr>
	...
	<td><input type="text" name="find_id" size="47" value="<?echo htmlspecialchars($find_id)?>"><?=InputType("checkbox", "find_id_exact_match", "Y", $find_id_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	...
	<td><?
		...
		echo SelectBoxFromArray("find_lamp", $arr, htmlspecialchars($find_lamp), GetMessage("AD_ALL"));
		?></td>
</tr>
<tr>
	<td valign="top"><?=GetMessage("AD_F_STATUS")?>:<br><img src="/bitrix/images/advertising/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td><?
		$arrStatus = CAdvBanner::GetStatusList();
...
<tr>
	...
	<td><input type="text" name="find_visitor_count_1" size="10" value="<?=htmlspecialchars($find_visitor_count_1)?>"><?echo "&nbsp;".GetMessage("AD_TILL")."&nbsp;"?><input type="text" name="find_visitor_count_2" size="10" value="<?=htmlspecialchars($find_visitor_count_2)?>"></td>
</tr>
<tr>
	<td><?=GetMessage("AD_F_SHOW_COUNT")?>:</td>
	<td><input type="text" name="find_show_count_1" size="10" value="<?=htmlspecialchars($find_show_count_1)?>"><?echo "&nbsp;".GetMessage("AD_TILL")."&nbsp;"?><input type="text" name="find_show_count_2" size="10" value="<?=htmlspecialchars($find_show_count_2)?>"></td>
</tr>
<tr>
	<td><?=GetMessage("AD_F_CLICK_COUNT")?>:</td>
	<td><input type="text" name="find_click_count_1" size="10" value="<?=htmlspecialchars($find_click_count_1)?>"><?echo "&nbsp;".GetMessage("AD_TILL")."&nbsp;"?><input type="text" name="find_click_count_2" size="10" value="<?=htmlspecialchars($find_click_count_2)?>"></td>
</tr>
<tr>
	<td nowrap><?=GetMessage("AD_F_CTR")?>:</td>
	<td><input type="text" name="find_ctr_1" size="10" value="<?=htmlspecialchars($find_ctr_1)?>"><?echo "&nbsp;".GetMessage("AD_TILL")."&nbsp;"?><input type="text" name="find_ctr_2" size="10" value="<?=htmlspecialchars($find_ctr_2)?>"></td>
</tr>
<tr>
	<td valign="top"><?=GetMessage("AD_F_GROUP")?>:</td>
	<td><input type="text" name="find_group" size="47" value="<?echo htmlspecialchars($find_group)?>"><?=InputType("checkbox", "find_group_exact_match", "Y", $find_group_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td valign="top"><?=GetMessage("AD_F_CONTRACT")?>:<br><img src="/bitrix/images/advertising/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td><input type="text" name="find_contract" size="47" value="<?echo htmlspecialchars($find_contract)?>"><?=InputType("checkbox", "find_contract_exact_match", "Y", $find_contract_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?><br><?
...
<tr>
	<td valign="top"><?=GetMessage("AD_F_TYPE")?>:<br><img src="/bitrix/images/advertising/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td><input type="text" name="find_type" size="47" value="<?echo htmlspecialchars($find_type)?>"><?=InputType("checkbox", "find_type_exact_match", "Y", $find_type_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?><br><?
		$ref_id = array();
		$ref = array();
...
<tr>
	...
	<td><input type="text" name="find_name" size="47" value="<?echo htmlspecialchars($find_name)?>"><?=InputType("checkbox", "find_name_exact_match", "Y", $find_name_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>

<tr>
	<td><?echo GetMessage("AD_F_CODE")?>:</td>
	<td><input type="text" name="find_code" size="47" value="<?echo htmlspecialchars($find_code)?>"><?=InputType("checkbox", "find_code_exact_match", "Y", $find_code_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?echo GetMessage("AD_F_COMMENTS")?>:</td>
	<td><input type="text" name="find_comments" size="47" value="<?echo htmlspecialchars($find_comments)?>"><?=InputType("checkbox", "find_comments_exact_match", "Y", $find_comments_exact_match, false, "", "title='".GetMessage("AD_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<?
