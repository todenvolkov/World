				...
				foreach($arShow as $ctype) :
					...
					if ( ${"sum_".strtolower($counter_type)}>0):
						...
						<table cellspacing=0 cellpadding=2 class="graph">
							<tr>
								<td valign="top"><img class="graph" src="/bitrix/admin/adv_diagram.php?<?=GetFilterParams($FilterArr)?>&diameter=<?echo $diameter?>&diagram_type=<?echo $diagram_type?>&counter_type=<?echo $counter_type?>" width="<?echo $diameter?>" height="<?echo $diameter?>">
								</td>
								<td valign="top">
