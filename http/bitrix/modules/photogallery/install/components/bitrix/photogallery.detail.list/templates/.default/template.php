...
if ($sTemplateName != "default"):
	$arParams["MAX_WIDTH"] = $arParams["MAX_HEIGHT"] = $arParams["THUMBS_SIZE"];
else: 
	$arParams["MAX_WIDTH"] = ($arResult["ELEMENTS"]["MAX_WIDTH"] < $arParams["THUMBS_SIZE"] ? $arResult["ELEMENTS"]["MAX_WIDTH"] : $arParams["THUMBS_SIZE"]);
	$arParams["MAX_HEIGHT"] = ($arResult["ELEMENTS"]["MAX_HEIGHT"] < $arParams["THUMBS_SIZE"] ? $arResult["ELEMENTS"]["MAX_HEIGHT"] : $arParams["THUMBS_SIZE"]);
endif;
...
foreach ($arResult["ELEMENTS_LIST"]	as $key => $arItem):
	...
	$arItem["TITLE"] = htmlspecialcharsEx($arItem["~NAME"].($arItem["ACTIVE"] != "Y" ? GetMessage("P_PHOTO_NOT_APPROVED") : ""));
...
if ($arParams["INCLUDE_SLIDER"] == "Y"):
	$this->__component->__templateName = "slider_big";
