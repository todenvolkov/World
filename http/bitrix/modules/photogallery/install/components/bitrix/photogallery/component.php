...
if ($_SERVER['REQUEST_METHOD'] == "POST" && (intVal($arVariables["ELEMENT_ID"]) > 0 || strLen($arVariables["ELEMENT_CODE"]) > 0) && 
	intVal($arResult["VARIABLES"]["SECTION_ID"]) <= 0)
{
...
$arParams["ALBUM_PHOTO_SIZE"] = intval(intval($arParams["ALBUM_PHOTO_SIZE"]) > 0 ? $arParams["ALBUM_PHOTO_SIZE"] : 150);
$arParams["ALBUM_PHOTO_THUMBS_SIZE"] = intval(intval($arParams["ALBUM_PHOTO_THUMBS_SIZE"]) > 0 ? $arParams["ALBUM_PHOTO_THUMBS_SIZE"] : 150);
