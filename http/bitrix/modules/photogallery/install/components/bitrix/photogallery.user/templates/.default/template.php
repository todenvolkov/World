...
<??>
			<li class="photo-control photo-control-last photo-control-album-upload">
				<a tafget="_self" rel="nofollow" href="<?=$arResult["GALLERY"]["LINK"]["UPLOAD"]?>"><span><?=GetMessage("P_UPLOAD")?></span></a>
			</li>
		</ul>
	</div>
	</noindex>
...
?>
			<td>
				<div class="photo-control">( <a tafget="_self" href="<?=$arResult["GALLERY"]["LINK"]["EDIT"]?>"><?=GetMessage("P_EDIT")?></a> )</div>
			</td>
<?
}
?>
