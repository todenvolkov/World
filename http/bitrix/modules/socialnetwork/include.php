...
if (COption::GetOptionString("socialnetwork", "allow_blog_user", "Y") == "Y" || COption::GetOptionString("socialnetwork", "allow_blog_group", "Y") == "Y")
{
	$arSocNetFeaturesSettings["blog"] = array(
		...
		"subscribe_events" 			=> array(
			...
			"blog_post" =>  array(
				...
				"HIDDEN"		=> true,
				"CLASS_FORMAT"	=> "CSocNetLog",
				"METHOD_FORMAT"	=> "FormatEvent_BlogPostComment",
				"HAS_CB"		=> "Y"
			),
			"blog_comment" =>  array(
				"ENTITIES"	=>	array(),
	...
	if (COption::GetOptionString("socialnetwork", "allow_blog_user", "Y") == "Y")
	{
		...
		$arSocNetFeaturesSettings["blog"]["subscribe_events"]["blog_comment"]["ENTITIES"][SONET_SUBSCRIBE_ENTITY_USER] = array(
				"TITLE" => GetMessage("SOCNET_LOG_BLOG_COMMENT_USER")
			);
	...
	if (COption::GetOptionString("socialnetwork", "allow_blog_group", "Y") == "Y")
	{
		...
		$arSocNetFeaturesSettings["blog"]["subscribe_events"]["blog_comment"]["ENTITIES"][SONET_SUBSCRIBE_ENTITY_GROUP] = array(
				"TITLE" => GetMessage("SOCNET_LOG_BLOG_COMMENT_GROUP")
			);
		...
		$arSocNetFeaturesSettings["blog"]["operations"]["write_post"][SONET_ENTITY_GROUP] = COption::GetOptionString("socialnetwork", "default_blog_operation_write_post_group", SONET_ROLES_MODERATOR);
