...
if (
	!file_exists($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/managed_cache/socnet/c/".IntVal($cuid / 1000)."/".$cuid."_m")
	&& !file_exists($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/managed_cache/socnet/c/".IntVal($cuid / 1000)."/".$cuid."_f")
	&& !file_exists($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/managed_cache/socnet/c/".IntVal($cuid / 1000)."/".$cuid."_g")
	)
	die();
