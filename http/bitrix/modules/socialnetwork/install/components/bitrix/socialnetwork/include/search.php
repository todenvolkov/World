...
if (strpos($componentPage, "user_content_search") === false)
{
	...
	$APPLICATION->AddChainItem($arGroup["NAME"], CComponentEngine::MakePathFromTemplate(htmlspecialchars($arResult["PATH_TO_GROUP"]), array("group_id" => $arGroup["ID"])));
}
else
{
	...
	$APPLICATION->AddChainItem($strTitleFormatted, CComponentEngine::MakePathFromTemplate(htmlspecialchars($arResult["PATH_TO_USER"]), array("user_id" => $arUser["ID"])));
}
...
if (strpos($componentPage, "user_content_search") === false)
	$url = CComponentEngine::MakePathFromTemplate(htmlspecialchars($arResult["PATH_TO_GROUP_CONTENT_SEARCH"]), array("group_id" => $arResult["VARIABLES"]["group_id"]));
else
	$url = CComponentEngine::MakePathFromTemplate(htmlspecialchars($arResult["PATH_TO_USER_CONTENT_SEARCH"]), array("user_id" => $arResult["VARIABLES"]["user_id"]));
