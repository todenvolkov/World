...
else
{
	...
	$arDesktopParams = Array(
			...
			"G_UPDATES_ENTITY_TEMPLATE_NAME" => "short",
			...
			"G_UPDATES_ENTITY_LIST_URL" => ($arParams["LOG_SUBSCRIBE_ONLY"] != "Y" ? htmlspecialcharsback($arResult["Urls"]["GroupLog"]) : $arParams["~PATH_TO_USER_LOG"]),
