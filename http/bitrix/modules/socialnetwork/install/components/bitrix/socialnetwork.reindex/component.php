...
if(intval($arParams["FORUM_ID"]) && CModule::IncludeModule('forum'))
{
	...
	if($arForum["INDEXATION"]!=="Y")
		$arWarnings[] = GetMessage("CC_BSR_WARN_FORUM", array("#href#" => htmlspecialchars(BX_ROOT."/admin/forum_edit.php?lang=".LANGUAGE_ID."&ID=".intval($arForum["ID"]))));
...
if(intval($arParams["PHOTO_GROUP_IBLOCK_ID"]) && CModule::IncludeModule('iblock'))
{
	...
	if($arIBlock["INDEX_ELEMENT"]==="Y")
		$arWarnings[] = GetMessage("CC_BSR_WARN_PHOTO_GROUP_IBLOCK", array("#href#" => htmlspecialchars(BX_ROOT."/admin/iblock_edit.php?type=".urlencode($arIBlock["IBLOCK_TYPE_ID"])."&lang=".LANGUAGE_ID."&ID=".urlencode($arIBlock["ID"])."&admin=Y&return_url=".urlencode($APPLICATION->GetCurPageParam()))));
...
if(intval($arParams["PHOTO_USER_IBLOCK_ID"]) && CModule::IncludeModule('iblock'))
{
	...
	if($arIBlock["INDEX_ELEMENT"]==="Y")
		$arWarnings[] = GetMessage("CC_BSR_WARN_PHOTO_USER_IBLOCK", array("#href#" => htmlspecialchars(BX_ROOT."/admin/iblock_edit.php?type=".urlencode($arIBlock["IBLOCK_TYPE_ID"])."&lang=".LANGUAGE_ID."&ID=".urlencode($arIBlock["ID"])."&admin=Y&return_url=".urlencode($APPLICATION->GetCurPageParam()))));
...
if(array_key_exists("group_photos", $arSteps) || array_key_exists("user_photos", $arSteps))
{
	if(intval($arParams["PHOTO_FORUM_ID"]) && CModule::IncludeModule('forum'))
	{
		...
		if($arForum["INDEXATION"]!=="Y")
			$arWarnings[] = GetMessage("CC_BSR_WARN_PHOTO_FORUM", array("#href#" => htmlspecialchars(BX_ROOT."/admin/forum_edit.php?lang=".LANGUAGE_ID."&ID=".intval($arForum["ID"]))));
	}
}
...
if(intval($arParams["CALENDAR_GROUP_IBLOCK_ID"]) && CModule::IncludeModule('iblock'))
{
	...
	if($arIBlock["INDEX_ELEMENT"]==="Y")
		$arWarnings[] = GetMessage("CC_BSR_WARN_CALENDAR_GROUP_IBLOCK", array("#href#" => htmlspecialchars(BX_ROOT."/admin/iblock_edit.php?type=".urlencode($arIBlock["IBLOCK_TYPE_ID"])."&lang=".LANGUAGE_ID."&ID=".urlencode($arIBlock["ID"])."&admin=Y&return_url=".urlencode($APPLICATION->GetCurPageParam()))));
...
if(intval($arParams["TASK_IBLOCK_ID"]) && CModule::IncludeModule('iblock'))
{
	...
	if($arIBlock["INDEX_ELEMENT"]==="Y")
		$arWarnings[] = GetMessage("CC_BSR_WARN_TASK_IBLOCK", array("#href#" => htmlspecialchars(BX_ROOT."/admin/iblock_edit.php?type=".urlencode($arIBlock["IBLOCK_TYPE_ID"])."&lang=".LANGUAGE_ID."&ID=".urlencode($arIBlock["ID"])."&admin=Y&return_url=".urlencode($APPLICATION->GetCurPageParam()))));

	if(intval($arParams["TASK_FORUM_ID"]) && CModule::IncludeModule('forum'))
	{
		$arForum = CForumNew::GetByID($arParams["TASK_FORUM_ID"]);
		if($arForum["INDEXATION"]!=="Y")
			$arWarnings[] = GetMessage("CC_BSR_WARN_TASK_FORUM", array("#href#" => htmlspecialchars(BX_ROOT."/admin/forum_edit.php?lang=".LANGUAGE_ID."&ID=".intval($arForum["ID"]))));
	}
...
if(intval($arParams["FILES_GROUP_IBLOCK_ID"]) && CModule::IncludeModule('iblock'))
{
	...
	if($arIBlock["INDEX_ELEMENT"]==="Y")
		$arWarnings[] = GetMessage("CC_BSR_WARN_FILE_GROUP_IBLOCK", array("#href#" => htmlspecialchars(BX_ROOT."/admin/iblock_edit.php?type=".urlencode($arIBlock["IBLOCK_TYPE_ID"])."&lang=".LANGUAGE_ID."&ID=".urlencode($arIBlock["ID"])."&admin=Y&return_url=".urlencode($APPLICATION->GetCurPageParam()))));
...
if(intval($arParams["FILES_USER_IBLOCK_ID"]) && CModule::IncludeModule('iblock'))
{
	...
	if($arIBlock["INDEX_ELEMENT"]==="Y")
		$arWarnings[] = GetMessage("CC_BSR_WARN_FILE_USER_IBLOCK", array("#href#" => htmlspecialchars(BX_ROOT."/admin/iblock_edit.php?type=".urlencode($arIBlock["IBLOCK_TYPE_ID"])."&lang=".LANGUAGE_ID."&ID=".urlencode($arIBlock["ID"])."&admin=Y&return_url=".urlencode($APPLICATION->GetCurPageParam()))));
...
if(array_key_exists("group_files", $arSteps) || array_key_exists("user_files", $arSteps))
{
	if(intval($arParams["FILES_FORUM_ID"]) && CModule::IncludeModule('forum'))
	{
		...
		if($arForum["INDEXATION"]!=="Y")
			$arWarnings[] = GetMessage("CC_BSR_WARN_FILES_FORUM", array("#href#" => htmlspecialchars(BX_ROOT."/admin/forum_edit.php?lang=".LANGUAGE_ID."&ID=".intval($arForum["ID"]))));
	}
}

if(count($arWarnings) > 0)
	$arWarnings[] = GetMessage("CC_BSR_WARN_REINDEX", array("#href#" => htmlspecialchars(BX_ROOT."/admin/search_reindex.php?lang=".LANGUAGE_ID)));
