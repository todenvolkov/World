...
<tr valign="top">
	...
	<td valign="top" nowrap>
		...
		<input type="checkbox" name="W_SUPPORT_ADD_MESSAGE_AS_HIDDEN" value="Y" <?if($W_SUPPORT_ADD_MESSAGE_AS_HIDDEN=="Y") echo "checked"?> id="w_support_add_message_as_hidden"><label for="W_SUPPORT_ADD_MESSAGE_AS_HIDDEN"><?echo GetMessage("SUPPORT_MAIL_HIDDEN")?></label><br>
	</td>
</tr>
...
<tr valign="top">
	...
	?>
	<textarea name="W_SUPPORT_SUBJECT" style="width:80%;height:200px;" wrap="off"><?=htmlspecialchars($W_SUPPORT_SUBJECT)?></textarea></td>
</tr>
<?
$arrSiteRef = array();
$arrSiteID = array();
...
<tr valign="top">
	...
	<td valign="top"><?
	echo SelectBoxFromArray("W_SUPPORT_SITE_ID", array("reference" => $arrSiteRef, "reference_id" => $arrSiteID), htmlspecialchars($W_SUPPORT_SITE_ID), GetMessage("SUPPORT_MAIL_MAILBOX"), "onChange=\"DictionaryList(this[this.selectedIndex].value)\" ");?></td>
</tr>
