...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	foreach($arG as $gid)
	{
		...
		$str .= '[<a title="'.GetMessage("MAIN_ADMIN_MENU_EDIT").'" href="/bitrix/admin/group_edit.php?ID='.$gid.'&lang='.LANG.'">'.$gid.'</a>] '.htmlspecialchars($arGROUPS[$gid]).'<br>';
	}
...
<tr> 
	...
	<td><input type="text" name="find_description" size="47" value="<?=htmlspecialchars($find_description)?>"><?=InputType("checkbox", "find_description_exact_match", "Y", $find_description_exact_match, false, "", "title='".GetMessage("SUP_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
