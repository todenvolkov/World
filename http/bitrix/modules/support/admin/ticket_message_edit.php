...
if ($arTicket = $rsTicket->Fetch())
{
	...
	$sDocTitle = eregi_replace("#ID#","$ID",GetMessage("SUP_EDIT_RECORD"));
	$sDocTitle = eregi_replace("#TID#","$TICKET_ID",$sDocTitle);
...
?>
	...
	<tr valign="top">
		...
		echo SelectBoxFromArray("IS_SPAM", $arr, htmlspecialchars($str_IS_SPAM), " ");
		?></td>
	</tr>
