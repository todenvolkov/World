...
if($SUP_RIGHT>"D")
{
	...
	if ($SUP_RIGHT>="V")
	{
		...
		/*
		$aMenu["items"][] = array(
			"text" => GetMessage("SUP_M_USER_IN_GROUPS"),
			"url" => "ticket_usergroup_list.php?lang=".LANGUAGE_ID,
			"more_url" => Array(
				"ticket_usergroup_edit.php",
				"ticket_usergroup_list.php",
			),
			"title" => GetMessage("SUP_M_USER_IN_GROUPS_TITLE")
		);
		*/
		$aMenu["items"][] = array(
