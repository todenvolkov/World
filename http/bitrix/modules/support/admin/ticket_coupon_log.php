...
<tr>
	...
	<td><input type="text" name="FIND_COUPON" size="47" value="<?=htmlspecialchars($FIND_COUPON)?>"><?=InputType("checkbox", "FIND_NAME_EXACT_MATCH", "Y", $FIND_NAME_EXACT_MATCH, false, "")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?=GetMessage("SUP_CL_FLT_COUPON_ID")?>:</td>
	<td><input type="text" name="FIND_COUPON_ID" size="47" value="<?=htmlspecialchars($FIND_COUPON_ID)?>"></td>
</tr>
