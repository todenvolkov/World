...
$arHeaders=array(
	...
	array("id"=>"COUNT", "content"=>GetMessage("SEARCH_TAGSTAT_COUNT"), "sort"=>"COUNT", "default"=>true, "align"=>"right"),
);
...
<tr>
	...
	<td><?echo SelectBoxFromArray("find_site_id", $arSiteDropdown, $find_site_id, GetMessage("SEARCH_TAGSTAT_SITE"));?></td>
</tr>
