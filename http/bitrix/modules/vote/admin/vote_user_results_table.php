...
if (!($event=CVoteEvent::GetByID($EVENT_ID)))
{
    ...
    ?><a href="vote_user_list.php?lang=<?=LANGUAGE_ID?>" class="navchain"><?=GetMessage("VOTE_USER_LIST")?></a><font class="navchain">&nbsp;&raquo&nbsp;</font><a href="vote_user_votes_table.php?lang=<?=LANGUAGE_ID?>&VOTE_ID=<?=$VOTE_ID?>" class="navchain"><?=GetMessage("VOTE_RESULTS_LIST")?></a><?
