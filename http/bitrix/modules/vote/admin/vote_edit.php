...
if((strlen($save)>0 || strlen($apply)>0) && $_SERVER["REQUEST_METHOD"]=="POST" && $VOTE_RIGHT=="W" && check_bitrix_sessid())
{
    ...
    elseif(isset($_REQUEST["IMAGE_ID"]) && is_file($_SERVER["DOCUMENT_ROOT"].$_REQUEST["IMAGE_ID"]))
    {
...
?>
	...
	<tr>
		...
		<td width="60%"><input type="checkbox" name="NOTIFY" id="NOTIFY" value="Y" <?=($arVote["NOTIFY"] == "Y" ? " checked" : "")?> />
