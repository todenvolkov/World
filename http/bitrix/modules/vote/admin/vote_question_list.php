...
$adminChain->AddItem(array(
	"TEXT"=> (strlen($arVote["TITLE"]) > 0 ? htmlspecialchars($arVote["TITLE"]) : TruncateText(
	($arVote["DESCRIPTION_TYPE"] == "html" ? strip_tags($arVote["DESCRIPTION"]) : htmlspecialchars($arVote["DESCRIPTION"])), 200)), 
...
$lAdmin->AddHeaders(array(
                ...
                array("id"=>"TIMESTAMP_X", "content"=>GetMessage("VOTE_TIMESTAMP_X"), "sort"=>"s_timestamp", "default"=>true),
...
<tr>
	...
	<td nowrap><input type="text" name="find_question" value="<?echo htmlspecialchars($find_question)?>" size="47"><?=InputType("checkbox", "find_question_exact_match", "Y", $find_question_exact_match, false, "", "title='".GetMessage("VOTE_EXACT_MATCH")."'")?>&nbsp;<?=ShowFilterLogicHelp()?></td>
</tr>
<tr> 
	<td>ID:</td>
...
<tr valign="top">
	...
	<td nowrap><?
		$arr = array("reference"=>array(GetMessage("VOTE_YES"), GetMessage("VOTE_NO")), "reference_id"=>array("Y","N"));
		echo SelectBoxFromArray("find_diagram", $arr, htmlspecialchars($find_diagram), GetMessage("VOTE_ALL"));
		?></td>
</tr>
<tr valign="top">
	...
	<td nowrap><?
		$arr = array("reference"=>array(GetMessage("VOTE_YES"), GetMessage("VOTE_NO")), "reference_id"=>array("Y","N"));
        echo SelectBoxFromArray("find_required", $arr, htmlspecialchars($find_required), GetMessage("VOTE_ALL"));
		?></td>
</tr>
<?
