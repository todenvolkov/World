...
$MESS ['VOTE_PUBLIC_DIR'] = "Каталог опросов (без каталога сайта):";
$MESS ['VOTE_TEMPLATE_RESULTS_QUESTION_NEW'] = "Относительный путь к шаблонам для показа результатов вопроса:";
$MESS ['MAIN_RESTORE_DEFAULTS'] = "По умолчанию";
$MESS ['VOTE_COMPATIBLE'] = "Поддерживать старые шаблоны (default.php, bluebar.php) в форме редактирования вопросов:";
?>
