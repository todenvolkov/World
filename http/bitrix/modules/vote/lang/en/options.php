...
$MESS ['VOTE_TEMPLATE_RESULTS_QUESTION_NEW'] = "Relative path to the question result view templates:";
$MESS ['MAIN_RESTORE_DEFAULTS'] = "Restore defaults";
$MESS ['VOTE_COMPATIBLE'] = "Enable support for old templates (default.php, bluebar.php) in question edit form:";
?>
