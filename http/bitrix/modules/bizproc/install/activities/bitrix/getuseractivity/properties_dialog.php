...
<tr>
	...
	<td width="60%">
		<?=CBPDocument::ShowParameterField("user", 'user_parameter', $arCurrentValues['user_parameter'], Array('rows'=>'1'))?>
	</td>
</tr>
<tr id="tr_max_level">
...
<tr>
	...
	<td width="60%">
		<?=CBPDocument::ShowParameterField("user", 'reserve_user_parameter', $arCurrentValues['reserve_user_parameter'], Array('rows'=>'1'))?>
	</td>
</tr>
<script type="text/javascript">
