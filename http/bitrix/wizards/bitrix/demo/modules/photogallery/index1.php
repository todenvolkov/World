...
// 2. Import iblock
$iBlockId = 0;
$db_res = CIBlock::GetList(array(), array("CODE" => "gallery"));
...
else
{
	...
	$res = ImportXMLFile($source_base."xml/".LANGUAGE_ID."/photogallery_user.xml", "gallery", $SITE_ID);
...
$source = "/public/photogallery_user/";
