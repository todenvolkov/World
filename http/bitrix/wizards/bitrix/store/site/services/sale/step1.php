...
if(COption::GetOptionString("store", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	COption::SetOptionString("store", "siteTelephone", $siteTelephone, false, WIZARD_SITE_ID);
	...
	if(!($dbDiscount->Fetch()))
	{
		$arF = Array ( 
			...
			"ACTIVE" => "Y",
			"ACTIVE_FROM" => ConvertTimeStamp(mktime(0,0,0,12,15,2010), "FULL"),
			"ACTIVE_TO" => ConvertTimeStamp(mktime(0,0,0,01,15,2011), "FULL"),
			"RENEWAL" => "N",
		...
		$dbItem = CIBlockElement::GetList(Array(), Array("IBLOCK_TYPE" => "catalog", "!PROPERTY_SPECIALOFFER" => false, "IBLOCK_SITE_ID" => WIZARD_SITE_ID));
