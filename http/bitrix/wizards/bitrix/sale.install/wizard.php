...
class Step6 extends CWizardStep
{
	function InitStep()
	{
		...
		$arPermType = Array("PERM_VIEW", "PERM_CANCEL", "PERM_DELIVERY", "PERM_PAYMENT", "PERM_STATUS", "PERM_STATUS_FROM", "PERM_UPDATE", "PERM_DELETE");
...
class Step8 extends CWizardStep
{
	...
	function ShowStep()
	{
		...
		$location = Array();
		$dbLocationList = CSaleLocation::GetList(Array("SORT"=>"ASC", "COUNTRY_NAME_LANG"=>"ASC", "CITY_NAME_LANG"=>"ASC"), array(), $siteID);
