...
$MESS["SSEN_PERM_PAYMENT"] = "Payment flag";
...
$MESS["WW_STEP4_1"] = "Configure the payment system parameters (form items, shop ID's etc.). Doing this require that you specify the neccesary order fields for data retrieval.";
