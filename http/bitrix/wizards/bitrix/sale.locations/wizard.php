...
function checkZIP()
{
	var obCSVFileRus = document.getElementById('loc_ussr');
	var obCSVFileNone = document.getElementById('none');
	var obZIPFile = document.getElementById('load_zip');
	
	if (obCSVFileRus && obCSVFileNone && obZIPFile)
	{
		if (obCSVFileRus.checked || obCSVFileNone.checked)
