...
/*---------------------------------
					  Counter
	-----------------------------------*/
var home_counter = 12503849;
	window.setInterval(function(){ // Make an Ajax call to get correct number of downloads
		var cnt_str = parseInt(home_counter).toString();
		$('.counter').text(cnt_str);
			home_counter += 1},1000);
